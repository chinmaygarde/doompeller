        ...
        if (!(face->flags & (FACE_FLOOR | FACE_LADDER))) {
          ...
          for (k = 0; k < face->numEdges; k++) {
            ...
            if (!edgeRemap[abs(edgeNum)]) {
              ...
              newEdges[newEdges.Num() - 1].vertexNum[0] =
                  vertexRemap[edge->vertexNum[0]];
              newEdges[newEdges.Num() - 1].vertexNum[1] =
                  vertexRemap[edge->vertexNum[1]];
            }
          ...
          newFaces[newFaces.Num() - 1].numEdges =
              newEdgeIndex.Num() - faceFirstEdge;
        }
      }
