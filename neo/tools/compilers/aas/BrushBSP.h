...
class idBrushBSPPortal {
 ...
 public:
  ...
  void Flip(void);
  int Split(const idPlane& splitPlane,
...
class idBrushBSP {
 public:
  ...
  void Build(idBrushList brushList,
             int skipContents,
  ...
  bool RemoveOutside(const idMapFile* mapFile,
                     int contents,
 ...
 private:
  ...
  bool FloodFromEntities(const idMapFile* mapFile,
                         int contents,
                         const idStrList& classNames);
  ...
  void UpdateTreeAfterMerge_r(idBrushBSPNode* node,
  ...
  void MeltFlood_r(idBrushBSPNode* node,
                   int skipContents,
                   idBounds& bounds,
                   idVectorSet<idVec3, 3>& vertexList);
  void MeltLeafNodePortals(idBrushBSPNode* node,
                           int skipContents,
                           idVectorSet<idVec3, 3>& vertexList);
  void MeltPortals_r(idBrushBSPNode* node,
                     int skipContents,
                     idVectorSet<idVec3, 3>& vertexList);
};
