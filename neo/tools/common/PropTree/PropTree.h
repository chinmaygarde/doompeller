...
class PROPTREE_API CPropTree : public CWnd {
 ...
 public:
  ...
  BOOL EnumItems(CPropTreeItem* pItem,
                 ENUMPROPITEMPROC proc,
                 LPARAM lParam = 0L);

  // Insert a created CPropTreeItem into the control
  CPropTreeItem* InsertItem(CPropTreeItem* pItem,
 ...
 private:
  static BOOL CALLBACK EnumFindItem(CPropTree* pProp,
                                    CPropTreeItem* pItem,
                                    LPARAM lParam);
  static BOOL CALLBACK EnumSelectAll(CPropTree*,
                                     CPropTreeItem* pItem,
                                     LPARAM lParam);
