...
class rvGEWorkspace {
 public:
  ...
  void AddModifierSize(const char* modName,
                       float l,
                       float t,
                       float r,
                       float b,
 ...
 protected:
  ...
  rvGEModifier* CreateModifier(EModifierType type,
                               idWindow* window,
                               va_list args);
...
ID_INLINE rvGEWorkspace::ESourceControlState
rvGEWorkspace::GetSourceControlState(void) {
