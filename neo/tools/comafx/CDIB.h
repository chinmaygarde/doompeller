...
class CDIB {
 public:
  ...
  HANDLE GetDIBits(int nStartX = -1,
                   int nStartY = -1,
                   int nCx = -1,
                   int nCy = -1);
