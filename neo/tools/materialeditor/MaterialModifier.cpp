 ...
 */
AttributeMaterialModifier::AttributeMaterialModifier(
 ...
 */
AttributeMaterialModifierString::AttributeMaterialModifierString(
    MaterialDocManager* manager,
    const char* materialName,
    int stage,
    const char* key,
 ...
 */
AttributeMaterialModifierBool::AttributeMaterialModifierBool(
    MaterialDocManager* manager,
    const char* materialName,
    int stage,
    const char* key,
 ...
 */
StageDeleteModifier::StageDeleteModifier(MaterialDocManager* manager,
                                         const char* materialName,
                                         int stageNum,
                                         idDict stageData)
    : MaterialModifier(manager, materialName) {
...
void StageDeleteModifier::Undo() {
  MaterialDoc* material = manager->CreateMaterialDoc(materialName);
  material->InsertStage(stageNum, stageData.GetInt("stagetype"),
                        stageData.GetString("name"), false);
 ...
 */
AddMaterialModifier::AddMaterialModifier(MaterialDocManager* manager,
                                         const char* materialName,
 ...
 */
DeleteMaterialModifier::DeleteMaterialModifier(MaterialDocManager* manager,
                                               const char* materialName)
    : MaterialModifier(manager, materialName) {}
 ...
 */
RenameMaterialModifier::RenameMaterialModifier(MaterialDocManager* manager,
                                               const char* materialName,
                                               const char* oldName)
    : MaterialModifier(manager, materialName) {
 ...
 */
AddMaterialFolderModifier::AddMaterialFolderModifier(
    MaterialDocManager* manager,
    const char* materialName,
 ...
 */
RenameMaterialFolderModifier::RenameMaterialFolderModifier(
    MaterialDocManager* manager,
    const char* materialName,
    MaterialTreeView* view,
    HTREEITEM item,
 ...
 */
DeleteMaterialFolderModifier::DeleteMaterialFolderModifier(
    MaterialDocManager* manager,
    const char* materialName,
    MaterialTreeView* view,
    HTREEITEM parent,
