...
void MaterialEditorInit(void) {
  ...
  meMainFrame->LoadFrame(IDR_ME_MAINFRAME, WS_OVERLAPPEDWINDOW | FWS_ADDTOTITLE,
                         NULL, NULL);
...
/**
 * Called every frame by the doom engine to allow the material editor to process
 * messages.
 */
...
/**
 * Allows the doom engine to reflect console output to the material editors
 * console.
 */
