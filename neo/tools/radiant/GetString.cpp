...
CGetString::CGetString(LPCSTR pPrompt,
                       CString* pFeedback,
                       CWnd* pParent /*=NULL*/)
...
bool GetYesNo(const char* psQuery) {
  if (MessageBox(g_pParentWnd->GetSafeHwnd(), psQuery, "Query",
...
void ErrorBox(const char* sString) {
  ...
  MessageBox(g_pParentWnd->GetSafeHwnd(), sString, "Error",
             MB_OK | MB_ICONERROR | MB_TASKMODAL);
}
void InfoBox(const char* sString) {
  MessageBox(g_pParentWnd->GetSafeHwnd(), sString, "Info",
             MB_OK | MB_ICONINFORMATION | MB_TASKMODAL);
}
void WarningBox(const char* sString) {
  MessageBox(g_pParentWnd->GetSafeHwnd(), sString, "Warning",
