...
class CTabsDlg : public CDialog {
 ...
 protected:
  ...
  struct DockedWindowInfo {
    ...
    CTearoffContainerWindow m_Container;  // the floating window that will hold
                                          // m_Window when it's undocked
    CWnd* m_Window;
    CString m_Title;
    int m_ImageID;
    int m_ID;
