...
*/
#if !defined( \
    AFX_ENTKEYFINDREPLACE_H__1AE54C31_FC22_11D3_8A60_00500424438B__INCLUDED_)
...
// return vals for modal dialogue, any values will do that don't clash with the
// first 9 or so defined by IDOK etc
//
