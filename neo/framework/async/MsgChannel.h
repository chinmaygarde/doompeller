...
#define CONNECTIONLESS_MESSAGE_ID_MASK \
  0x7FFF  // value to mask away connectionless message id
...
class idMsgChannel {
 public:
  ...
  // Returns true if the channel is ready to send new data based on the maximum
  // rate.
 ...
 private:
  ...
  void UpdatePacketLoss(const int time,
