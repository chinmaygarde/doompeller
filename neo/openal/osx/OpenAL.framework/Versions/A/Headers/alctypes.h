...
/**
 * Convert Data When Loading.  Default false, currently applies only to
 * monophonic sounds
 */
 ...
 *  Set this before opening a new OAL device to indicate how many busses on the
 * mixer are desired. Get returns either the current devices bus count value, or
 * the value that will be used to open a device
 */
#define ALC_MIXER_MAXIMUM_BUSSES 0xF004

/**
 * Render Channels.
 * Allows a user to force OpenAL to render to stereo, regardless of the audio
 * hardware being used
 */
