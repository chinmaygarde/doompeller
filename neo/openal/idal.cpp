...
ALvoid(ALAPIENTRY* idalBufferData)(ALuint, ALenum, ALvoid*, ALsizei, ALsizei) =
    NULL;
...
ALvoid(ALAPIENTRY* idalSource3f)(ALuint, ALenum, ALfloat, ALfloat, ALfloat) =
    NULL;
...
const char* InitializeIDAL(HMODULE h) {
  ...
  idalGenBuffers =
      (ALvoid(ALAPIENTRY*)(ALsizei, ALuint*))GetProcAddress(h, "alGenBuffers");
  if (!idalGenBuffers) {
    return "alGenBuffers";
  }
  idalIsSource =
      (ALboolean(ALAPIENTRY*)(ALuint))GetProcAddress(h, "alIsSource");
  if (!idalIsSource) {
    return "alIsSource";
  }
  idalSourceStop =
      (ALvoid(ALAPIENTRY*)(ALuint))GetProcAddress(h, "alSourceStop");
  if (!idalSourceStop) {
    return "alSourceStop";
  }
  idalGetSourcei = (ALvoid(ALAPIENTRY*)(ALuint, ALenum, ALint*))GetProcAddress(
      h, "alGetSourcei");
  if (!idalGetSourcei) {
    return "alGetSourcei";
  }
  idalGetInteger =
      (ALint(ALAPIENTRY*)(ALenum))GetProcAddress(h, "alGetInteger");
  if (!idalGetInteger) {
    return "alGetInteger";
  }
  idalcSuspendContext =
      (ALCvoid(ALAPIENTRY*)(ALCcontext*))GetProcAddress(h, "alcSuspendContext");
  if (!idalcSuspendContext) {
    return "alcSuspendContext";
  }
  idalcMakeContextCurrent =
      (ALCboolean(ALAPIENTRY*)(ALCcontext*))GetProcAddress(
          h, "alcMakeContextCurrent");
  if (!idalcMakeContextCurrent) {
    return "alcMakeContextCurrent";
  }
  idalcProcessContext =
      (ALCvoid(ALAPIENTRY*)(ALCcontext*))GetProcAddress(h, "alcProcessContext");
  if (!idalcProcessContext) {
    return "alcProcessContext";
  }
  idalcDestroyContext =
      (ALCvoid(ALAPIENTRY*)(ALCcontext*))GetProcAddress(h, "alcDestroyContext");
  if (!idalcDestroyContext) {
    return "alcDestroyContext";
  }
  idalcGetString = (ALCubyte * (ALAPIENTRY*)(ALCdevice*, ALCenum))
      GetProcAddress(h, "alcGetString");
  if (!idalcGetString) {
    return "alcGetString";
  }
  idalBufferData =
      (ALvoid(ALAPIENTRY*)(ALuint, ALenum, ALvoid*, ALsizei,
                           ALsizei))GetProcAddress(h, "alBufferData");
  if (!idalBufferData) {
    return "alBufferData";
  }
  idalDeleteBuffers = (ALvoid(ALAPIENTRY*)(ALsizei, ALuint*))GetProcAddress(
      h, "alDeleteBuffers");
  if (!idalDeleteBuffers) {
    return "alDeleteBuffers";
  }
  idalIsExtensionPresent = (ALboolean(ALAPIENTRY*)(ALubyte*))GetProcAddress(
      h, "alIsExtensionPresent");
  ...
  idalGetEnumValue =
      (ALenum(ALAPIENTRY*)(ALubyte*))GetProcAddress(h, "alGetEnumValue");
  if (!idalGetEnumValue) {
    return "alGetEnumValue";
  }
  idalGetProcAddress =
      (ALvoid * (ALAPIENTRY*)(ALubyte*)) GetProcAddress(h, "alGetProcAddress");
  ...
  idalcOpenDevice =
      (ALCdevice * (ALAPIENTRY*)(ALubyte*)) GetProcAddress(h, "alcOpenDevice");
  if (!idalcOpenDevice) {
    return "alcOpenDevice";
  }
  idalListenerfv =
      (ALvoid(ALAPIENTRY*)(ALenum, ALfloat*))GetProcAddress(h, "alListenerfv");
  if (!idalListenerfv) {
    return "alListenerfv";
  }
  idalSourceQueueBuffers = (ALvoid(ALAPIENTRY*)(
      ALuint, ALsizei, ALuint*))GetProcAddress(h, "alSourceQueueBuffers");
  if (!idalSourceQueueBuffers) {
    return "alSourceQueueBuffers";
  }
  idalSourcei = (ALvoid(ALAPIENTRY*)(ALuint, ALenum, ALint))GetProcAddress(
      h, "alSourcei");
  if (!idalSourcei) {
    return "alSourcei";
  }
  idalListenerf =
      (ALvoid(ALAPIENTRY*)(ALenum, ALfloat))GetProcAddress(h, "alListenerf");
  if (!idalListenerf) {
    return "alListenerf";
  }
  idalcCloseDevice =
      (ALCvoid(ALAPIENTRY*)(ALCdevice*))GetProcAddress(h, "alcCloseDevice");
  if (!idalcCloseDevice) {
    return "alcCloseDevice";
  }
  idalIsBuffer =
      (ALboolean(ALAPIENTRY*)(ALuint))GetProcAddress(h, "alIsBuffer");
  if (!idalIsBuffer) {
    return "alIsBuffer";
  }
  idalSource3f = (ALvoid(ALAPIENTRY*)(ALuint, ALenum, ALfloat, ALfloat,
                                      ALfloat))GetProcAddress(h, "alSource3f");
  if (!idalSource3f) {
    return "alSource3f";
  }
  idalGenSources =
      (ALvoid(ALAPIENTRY*)(ALsizei, ALuint*))GetProcAddress(h, "alGenSources");
  if (!idalGenSources) {
    return "alGenSources";
  }
  idalSourcef = (ALvoid(ALAPIENTRY*)(ALuint, ALenum, ALfloat))GetProcAddress(
      h, "alSourcef");
  if (!idalSourcef) {
    return "alSourcef";
  }
  idalSourceUnqueueBuffers = (ALvoid(ALAPIENTRY*)(
      ALuint, ALsizei, ALuint*))GetProcAddress(h, "alSourceUnqueueBuffers");
  if (!idalSourceUnqueueBuffers) {
    return "alSourceUnqueueBuffers";
  }
  idalSourcePlay =
      (ALvoid(ALAPIENTRY*)(ALuint))GetProcAddress(h, "alSourcePlay");
  if (!idalSourcePlay) {
    return "alSourcePlay";
  }
  return NULL;
