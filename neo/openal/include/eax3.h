/*******************************************************************\
 *																	*
 *  EAX.H - Environmental Audio Extensions version 3.0 * for OpenAL and
 *DirectSound3D								*
 *																	*
 ********************************************************************/
...
/*
 * EAX Wrapper Interface (using Direct X 7)
...
/*
 * EAX Wrapper Interface (using Direct X 8)
...
#define DSPROPERTY_EAXLISTENER_IMMEDIATE \
...
#define EAXLISTENER_DEFAULTFLAGS                                           \
  (EAXLISTENERFLAGS_DECAYTIMESCALE | EAXLISTENERFLAGS_REFLECTIONSSCALE |   \
...
// OR these flags with property id
#define DSPROPERTY_EAXBUFFER_IMMEDIATE \
  0x00000000  // changes take effect immediately
