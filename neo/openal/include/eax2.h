...
#define DSPROPERTY_EAX20LISTENER_IMMEDIATE \
  0x00000000  // changes take effect immediately
#define DSPROPERTY_EAX20LISTENER_DEFERRED \
  0x80000000  // changes take effect later
#define DSPROPERTY_EAX20LISTENER_COMMITDEFERREDSETTINGS \
  (DSPROPERTY_EAX20LISTENER_NONE | DSPROPERTY_EAX20LISTENER_IMMEDIATE)
...
//              myFlags = EAXLISTENERFLAGS_DECAYTIMESCALE |
...
#define EAX20LISTENERFLAGS_DECAYTIMESCALE \
  0x00000001  // reverberation decay time
...
#define EAX20LISTENER_DEFAULTFLAGS                                             \
  (EAX20LISTENERFLAGS_DECAYTIMESCALE | EAX20LISTENERFLAGS_REFLECTIONSSCALE |   \
   EAX20LISTENERFLAGS_REFLECTIONSDELAYSCALE | EAX20LISTENERFLAGS_REVERBSCALE | \
   EAX20LISTENERFLAGS_REVERBDELAYSCALE | EAX20LISTENERFLAGS_DECAYHFLIMIT)
...
// OR these flags with property id
#define DSPROPERTY_EAX20BUFFER_IMMEDIATE \
  0x00000000  // changes take effect immediately
...
#define DSPROPERTY_EAX20BUFFER_COMMITDEFERREDSETTINGS \
  (DSPROPERTY_EAX20BUFFER_NONE | DSPROPERTY_EAX20BUFFER_IMMEDIATE)
...
#define EAX20BUFFERFLAGS_DIRECTHFAUTO \
  0x00000001  // affects DSPROPERTY_EAXBUFFER_DIRECTHF
#define EAX20BUFFERFLAGS_ROOMAUTO \
  0x00000002  // affects DSPROPERTY_EAXBUFFER_ROOM
...
#define EAX20BUFFER_DEFAULTFLAGS                               \
  (EAX20BUFFERFLAGS_DIRECTHFAUTO | EAX20BUFFERFLAGS_ROOMAUTO | \
