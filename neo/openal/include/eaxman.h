...
DECLARE_INTERFACE_(IEaxManager, IUnknown) {
  ...
  STDMETHOD(GetListenerDynamicAttributes)
  (THIS_ long, LPEMPOINT, long*, DWORD) PURE;
  STDMETHOD(GetSourceDynamicAttributes)
  (THIS_ long, LPEMPOINT, long*, float*, long*, float*, float*, LPEMPOINT,
   DWORD) PURE;
...
#define IEaxManager_GetListenerAttributes(p, a) \
  (p)->lpVtbl->GetListenerAttributes(p, a)
#define IEaxManager_GetSourceID(p, a, b) (p)->lpVtbl->GetSourceID(p, a, b)
#define IEaxManager_GetSourceAttributes(p, a, b) \
  (p)->lpVtbl->GetSourceAttributes(p, a, b)
#define IEaxManager_GetSourceNumInstances(p, a, b) \
  (p)->lpVtbl->GetSourceNumInstances(p, a, b)
#define IEaxManager_GetSourceInstancePos(p, a, b, c) \
  (p)->lpVtbl->GetSourceInstancePos(p, a, b, c)
#define IEaxManager_GetEnvironmentID(p, a, b) \
  (p)->lpVtbl->GetEnvironmentID(p, a, b)
#define IEaxManager_GetEnvironmentAttributes(p, a, b) \
  (p)->lpVtbl->GetEnvironmentAttributes(p, a, b)
#define IEaxManager_GetMaterialID(p, a, b) (p)->lpVtbl->GetMaterialID(p, a, b)
#define IEaxManager_GetMaterialAttributes(p, a, b) \
  (p)->lpVtbl->GetMaterialAttributes(p, a, b)
#define IEaxManager_GetGeometrySetID(p, a, b) \
  (p)->lpVtbl->GetGeometrySetID(p, a, b)
#define IEaxManager_GetListenerDynamicAttributes(p, a, b, c, d) \
  (p)->lpVtbl->GetListenerDynamicAttributes(p, a, b, c, d)
#define IEaxManager_GetSourceDynamicAttributes(p, a, b, c, d, e, f, g, h, i) \
  (p)->lpVtbl->GetSourceDynamicAttributes(p, a, b, c, d, e, f, g, h, i)
// #define IEaxManager_GetSubSpaceID(p,a,b,c)
// (p)->lpVtbl->GetSubSpaceID(p,a,b,c)
#define IEaxManager_GetEnvironmentName(p, a, b, c) \
...
#define IEaxManager_GetSourceNumInstances(p, a, b) \
  (p)->GetSourceNumInstances(a, b)
#define IEaxManager_GetSourceInstancePos(p, a, b, c) \
  (p)->GetSourceInstancePos(a, b, c)
#define IEaxManager_GetEnvironmentID(p, a, b) (p)->GetEnvironmentID(a, b)
#define IEaxManager_GetEnvironmentAttributes(p, a, b) \
  (p)->GetEnvironmentAttributes(a, b)
#define IEaxManager_GetMaterialID(p, a, b) (p)->GetMaterialID(a, b)
#define IEaxManager_GetMaterialAttributes(p, a, b) \
  (p)->GetMaterialAttributes(a, b)
#define IEaxManager_GetGeometrySetID(p, a, b) (p)->GetGeometrySetID(a, b)
#define IEaxManager_GetListenerDynamicAttributes(p, a, b, c, d) \
  (p)->GetListenerDynamicAttributes(a, b, c, d)
#define IEaxManager_GetSourceDynamicAttributes(p, a, b, c, d, e, f, g, h, i) \
  (p)->GetSourceDynamicAttributes(a, b, c, d, e, f, g, h, i)
// #define IEaxManager_GetSubSpaceID(p,a,b,c)
// (p)->GetSubSpaceID(a,b,c)
#define IEaxManager_GetEnvironmentName(p, a, b, c) \
  (p)->GetEnvironmentName(a, b, c)
#endif
