 ...
 */
#define COPYING2 \
  Copyright(C) Hannu Savolainen and Dev Mazumdar 1997. All rights reserved.
 ...
 *voice (P1=voice mode) _GUS_VOICEBALA	- Sets voice balence (P1, 0=left,
 ...
 *P2=high volume) _GUS_RAMPRATE	- Sets the speed for volume ramping (P1=scale,
 *P2=rate) _GUS_RAMPMODE	- Sets the volume ramping mode (P1=ramping mode)
