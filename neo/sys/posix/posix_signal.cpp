...
const int siglist[] = {SIGHUP, SIGQUIT, SIGILL, SIGTRAP, SIGIOT, SIGBUS, SIGFPE,
                       SIGSEGV, SIGPIPE, SIGABRT,
                       //	SIGTTIN,
                       //	SIGTTOU,
                       -1};

const char* signames[] = {
    "SIGHUP", "SIGQUIT", "SIGILL",  "SIGTRAP", "SIGIOT",
    "SIGBUS", "SIGFPE",  "SIGSEGV", "SIGPIPE", "SIGABRT",
    //	"SIGTTIN",
    //	"SIGTTOUT"
};
...
static void sig_handler(int signum, siginfo_t* info, void* context) {
  ...
  // NOTE: see sigaction man page, could verbose the whole siginfo_t and print
