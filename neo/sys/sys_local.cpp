...
const char* sysLanguageNames[] = {"english",  "spanish", "italian", "german",
                                  "french",   "russian", "polish",  "korean",
                                  "japanese", "chinese", NULL};

idCVar sys_lang("sys_lang",
                "english",
...
void idSysLocal::DLL_GetFileName(const char* baseName,
  ...
  idStr::snPrintf(dllName, maxLength,
                  "%s"
                  ".dylib",
                  baseName);
#else
