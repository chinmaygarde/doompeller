...
class SSDAsteroid : public SSDMover {
 ...
 public:
  ...
  void Init(idGameSSDWindow* _game,
  ...
  virtual void EntityUpdate();
  static SSDAsteroid* GetNewAsteroid(idGameSSDWindow* _game,
                                     const idVec3& startPosition,
                                     const idVec2& _size,
                                     float _speed,
                                     float rotate,
...
class SSDAstronaut : public SSDMover {
 ...
 public:
  ...
  static SSDAstronaut* GetNewAstronaut(idGameSSDWindow* _game,
                                       const idVec3& startPosition,
                                       float _speed,
                                       float rotate,
                                       int _health);
...
class SSDExplosion : public SSDEntity {
 ...
 public:
  ...
  virtual void EntityUpdate();
  static SSDExplosion* GetNewExplosion(idGameSSDWindow* _game,
                                       const idVec3& _position,
                                       const idVec2& _size,
                                       int _length,
                                       int _type,
...
class SSDPoints : public SSDEntity {
 ...
 public:
  ...
  static SSDPoints* GetNewPoints(idGameSSDWindow* _game,
                                 SSDEntity* _ent,
                                 int _points,
                                 int _length,
                                 int _distance,
...
class SSDProjectile : public SSDEntity {
 ...
 public:
  ...
  static SSDProjectile* GetNewProjectile(idGameSSDWindow* _game,
                                         const idVec3& _beginPosition,
                                         const idVec3& _endPosition,
                                         float _speed,
                                         float _size);
 ...
 *	Super Blaster - Increases the power of the blaster (lasts a specific
 *amount of time) Asteroid Nuke - Destroys all asteroids on screen as soon as it
 *is aquired Rescue Powerup - Rescues all astronauts as soon as it is acquited
...
class SSDPowerup : public SSDMover {
 ...
 public:
  ...
  static SSDPowerup* GetNewPowerup(idGameSSDWindow* _game,
                                   float _speed,
                                   float _rotation);
...
class idGameSSDWindow : public idWindow {
 public:
  ...
  virtual idWinVar* GetWinVarByName(const char* _name,
