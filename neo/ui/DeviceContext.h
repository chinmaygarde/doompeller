...
class idDeviceContext {
 public:
  ...
  void DrawMaterialRotated(float x,
                           float y,
                           float w,
                           float h,
                           const idMaterial* mat,
                           ...
                           float scaley = 1.0,
                           float angle = 0.0f);
  void DrawStretchPicRotated(float x,
                             float y,
                             float w,
                             float h,
                             float s0,
  ...
  idRegion* GetTextRegion(const char* text,
                          float textScale,
                          idRectangle rectDraw,
                          float xStart,
                          float yStart);
