...
class idRenderModelStatic : public idRenderModel {
 public:
  ...
  struct aseModel_s* ConvertLWOToASE(const struct st_lwObject* obj,
                                     const char* fileName);
...
class idMD5Mesh {
 ...
 public:
  ...
  void UpdateSurface(const struct renderEntity_s* ent,
 ...
 private:
  ...
  void TransformScaledVerts(idDrawVert* verts,
                            const idJointMat* joints,
                            float scale);
};
...
class idRenderModelMD5 : public idRenderModelStatic {
 ...
 private:
  ...
  void DrawJoints(const renderEntity_t* ent,
...
class idRenderModelMD3 : public idRenderModelStatic {
 ...
 private:
  ...
  void LerpMeshVertexes(srfTriangles_t* tri,
