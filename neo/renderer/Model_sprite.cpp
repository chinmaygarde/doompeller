...
idRenderModel* idRenderModelSprite::InstantiateDynamicModel(
  ...
  idVec3 right = idVec3(
      0.0f, renderEntity->shaderParms[SHADERPARM_SPRITE_WIDTH] * 0.5f, 0.0f);
  idVec3 up = idVec3(
      0.0f, 0.0f, renderEntity->shaderParms[SHADERPARM_SPRITE_HEIGHT] * 0.5f);
...
===============
*/
idBounds idRenderModelSprite::Bounds(
