...
static void RB_NV20_BumpAndLightFragment(void) {
  ...
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_A_NV, GL_TEXTURE1_ARB,
                     GL_EXPAND_NORMAL_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE0_ARB,
                     GL_EXPAND_NORMAL_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER0_NV, GL_RGB, GL_SPARE0_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_TRUE, GL_FALSE,
                      GL_FALSE);

  // stage 1 rgb multiplies texture 2 and 3 together
  // SPARE1 = TEXTURE2 * TEXTURE3
  qglCombinerInputNV(GL_COMBINER1_NV, GL_RGB, GL_VARIABLE_A_NV, GL_TEXTURE2_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER1_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE3_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER1_NV, GL_RGB, GL_SPARE1_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE,
                      GL_FALSE);
  ...
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_A_NV, GL_SPARE0_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_B_NV, GL_SPARE1_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER2_NV, GL_RGB, GL_SPARE0_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE,
                      GL_FALSE);

  // stage 2 alpha multiples spare0 * spare 1
  // SPARE0 = SPARE0 * SPARE1
  qglCombinerInputNV(GL_COMBINER2_NV, GL_ALPHA, GL_VARIABLE_A_NV, GL_SPARE0_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_BLUE);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_ALPHA, GL_VARIABLE_B_NV, GL_SPARE1_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_BLUE);
  qglCombinerOutputNV(GL_COMBINER2_NV, GL_ALPHA, GL_SPARE0_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE,
                      GL_FALSE);
  ...
  qglFinalCombinerInputNV(GL_VARIABLE_D_NV, GL_SPARE0_NV,
                          GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_A_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_B_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_C_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_RGB);
...
We are going to write alpha as light falloff * ( bump dot light ) *
lightProjection If the light isn't a monoLightShader, the lightProjection will
be skipped, because it will have to be done on an itterated basis
==================
*/
static void RB_NV20_DI_BumpAndLightPass(const drawInteraction_t* din,
...
static void RB_NV20_DiffuseColorFragment(void) {
  ...
  // when the vertex color is inverted, qglCombinerInputNV(GL_VARIABLE_B_NV)
  // will be changed
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_A_NV, GL_TEXTURE0_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_B_NV,
                     GL_PRIMARY_COLOR_NV, GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER0_NV, GL_RGB, GL_TEXTURE0_ARB, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE,
                      GL_FALSE);

  qglCombinerOutputNV(GL_COMBINER0_NV, GL_ALPHA, GL_DISCARD_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE, GL_FALSE,
                      GL_FALSE);
  ...
  qglFinalCombinerInputNV(GL_VARIABLE_C_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_D_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_E_NV, GL_TEXTURE0_ARB,
                          GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_F_NV, GL_TEXTURE1_ARB,
                          GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglFinalCombinerInputNV(GL_VARIABLE_G_NV, GL_ZERO, GL_UNSIGNED_IDENTITY_NV,
                          GL_ALPHA);
}
...
static void RB_NV20_DI_DiffuseColorPass(const drawInteraction_t* din) {
  ...
  GL_State(GLS_SRCBLEND_DST_ALPHA | GLS_DSTBLEND_ONE | GLS_DEPTHMASK |
           GLS_ALPHAMASK | backEnd.depthFunc);
...
static void RB_NV20_SpecularColorFragment(void) {
  ...
  // we want GL_CONSTANT_COLOR1_NV * PRIMARY_COLOR * TEXTURE2 * TEXTURE3 *
  // specular( TEXTURE0 * TEXTURE1 )
  ...
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE0_ARB,
                     GL_EXPAND_NORMAL_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER0_NV, GL_RGB, GL_SPARE0_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_SCALE_BY_TWO_NV,
                      GL_BIAS_BY_NEGATIVE_ONE_HALF_NV, GL_TRUE, GL_FALSE,
                      GL_FALSE);
  ...
  // the scale and bias steepen the specular curve
  qglCombinerInputNV(GL_COMBINER1_NV, GL_RGB, GL_VARIABLE_A_NV, GL_SPARE0_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER1_NV, GL_RGB, GL_VARIABLE_B_NV, GL_SPARE0_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER1_NV, GL_RGB, GL_SPARE0_NV, GL_DISCARD_NV,
                      GL_DISCARD_NV, GL_SCALE_BY_TWO_NV,
                      GL_BIAS_BY_NEGATIVE_ONE_HALF_NV, GL_FALSE, GL_FALSE,
                      GL_FALSE);
  ...
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_A_NV, GL_SPARE0_NV,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE3_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_C_NV,
                     GL_CONSTANT_COLOR1_NV, GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_D_NV, GL_TEXTURE2_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER2_NV, GL_RGB, GL_SPARE0_NV,
                      GL_SECONDARY_COLOR_NV, GL_DISCARD_NV, GL_NONE, GL_NONE,
  ...
  qglCombinerInputNV(GL_COMBINER3_NV, GL_RGB, GL_VARIABLE_B_NV,
                     GL_PRIMARY_COLOR_NV, GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER3_NV, GL_RGB, GL_SECONDARY_COLOR_NV,
                      GL_DISCARD_NV, GL_DISCARD_NV, GL_NONE, GL_NONE, GL_FALSE,
                      GL_FALSE, GL_FALSE);

  // stage 3 alpha does nothing

  // final combiner = GL_SPARE0_NV * SECONDARY_COLOR + PRIMARY_COLOR *
  // SECONDARY_COLOR
...
static void RB_NV20_DiffuseAndSpecularColorFragment(void) {
  ...
  qglCombinerInputNV(GL_COMBINER0_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE0_ARB,
                     GL_EXPAND_NORMAL_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER0_NV, GL_RGB, GL_SECONDARY_COLOR_NV,
                      GL_DISCARD_NV, GL_DISCARD_NV, GL_SCALE_BY_TWO_NV,
                      GL_BIAS_BY_NEGATIVE_ONE_HALF_NV, GL_TRUE, GL_FALSE,
                      GL_FALSE);
  ...
  qglCombinerInputNV(GL_COMBINER1_NV, GL_RGB, GL_VARIABLE_B_NV,
                     GL_SECONDARY_COLOR_NV, GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER1_NV, GL_RGB, GL_SECONDARY_COLOR_NV,
                      GL_DISCARD_NV, GL_DISCARD_NV, GL_SCALE_BY_TWO_NV,
                      GL_BIAS_BY_NEGATIVE_ONE_HALF_NV, GL_FALSE, GL_FALSE,
                      GL_FALSE);
  ...
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_B_NV, GL_TEXTURE3_ARB,
                     GL_UNSIGNED_IDENTITY_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_C_NV, GL_ZERO,
                     GL_UNSIGNED_INVERT_NV, GL_RGB);
  qglCombinerInputNV(GL_COMBINER2_NV, GL_RGB, GL_VARIABLE_D_NV, GL_ZERO,
                     GL_UNSIGNED_INVERT_NV, GL_RGB);
  qglCombinerOutputNV(GL_COMBINER2_NV, GL_RGB, GL_SECONDARY_COLOR_NV,
                      GL_SPARE0_NV, GL_DISCARD_NV, GL_SCALE_BY_TWO_NV, GL_NONE,
                      GL_FALSE, GL_FALSE, GL_FALSE);

  // stage 2 alpha does nothing

  // final combiner = TEXTURE2_ARB * CONSTANT_COLOR0_NV + PRIMARY_COLOR_NV *
  // CONSTANT_COLOR1_NV alpha = GL_ZERO
...
==================
*/
static void RB_NV20_DI_DiffuseAndSpecularColorPass(
...
static void RB_NV20_DrawInteraction(const drawInteraction_t* din) {
  ...
  // vertex color passes should be pretty rare (cross-faded bump map surfaces),
  // so always run them down as three-passes
  ...
  // on NV20, we need to decide which single / dual / tripple pass set of
  // programs to use
...
static void RB_NV20_CreateDrawInteractions(const drawSurf_t* surf) {
  ...
  for (; surf; surf = surf->nextOnLight) {
    ...
    GL_SelectTexture(1);
    qglTexCoordPointer(3, GL_FLOAT, sizeof(idDrawVert),
...
void RB_NV20_DrawInteractions(void) {
  ...
  for (vLight = backEnd.viewDef->viewLights; vLight; vLight = vLight->next) {
    ...
    if (r_useShadowVertexProgram.GetBool()) {
      ...
      qglDisable(
          GL_VERTEX_PROGRAM_ARB);  // if there weren't any globalInteractions,
                                   // it would have stayed on
    } else {
      RB_StencilShadowPass(vLight->globalShadows);
      RB_NV20_CreateDrawInteractions(vLight->localInteractions);
      RB_StencilShadowPass(vLight->localShadows);
...
void R_NV20_Init(void) {
  ...
  if (!glConfig.registerCombinersAvailable ||
      !glConfig.ARBVertexProgramAvailable || glConfig.maxTextureUnits < 4) {
  ...
  qglNewList(fragmentDisplayListBase + FPROG_DIFFUSE_AND_SPECULAR_COLOR,
             GL_COMPILE);
  RB_NV20_DiffuseAndSpecularColorFragment();
  qglEndList();
