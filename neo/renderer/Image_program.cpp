...
=================
*/
static void R_HeightmapToNormalMap(byte* data,
                                   int width,
                                   int height,
                                   float scale) {
  int i, j;
  ...
  for (i = 0; i < height; i++) {
    for (j = 0; j < width; j++) {
      ...
      a4 = d4 =
          depth[(((i + 1) & (height - 1)) * width + ((j + 1) & (width - 1)))];
...
===================
*/
static void R_AddNormalMaps(byte* data1,
                            int width1,
                            int height1,
                            byte* data2,
                            int width2,
...
===================
*/
static void R_ImageAdd(byte* data1,
                       int width1,
                       int height1,
                       byte* data2,
                       int width2,
...
===================
*/
static bool R_ParseImageProgram_r(idLexer& src,
                                  byte** pic,
                                  int* width,
                                  int* height,
...
void R_LoadImageProgram(const char* name,
  ...
  src.SetFlags(LEXFL_NOFATALERRORS | LEXFL_NOSTRINGCONCAT |
