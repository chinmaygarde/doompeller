...
EXTERN void jpeg_set_quality JPP((j_compress_ptr cinfo,
                                  int quality,
                                  boolean force_baseline));
EXTERN void jpeg_set_linear_quality JPP((j_compress_ptr cinfo,
                                         int scale_factor,
                                         boolean force_baseline));
EXTERN void jpeg_add_quant_table JPP((j_compress_ptr cinfo,
                                      int which_tbl,
...
EXTERN void jpeg_write_marker JPP((j_compress_ptr cinfo,
                                   int marker,
