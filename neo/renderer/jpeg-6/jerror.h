      ...
      JMESSAGE(JERR_BAD_ALLOC_CHUNK, "MAX_ALLOC_CHUNK is wrong, please fix") JMESSAGE(
          ...
          JMESSAGE(JERR_BAD_IN_COLORSPACE, "Bogus input colorspace") JMESSAGE(
              ...
              "Bogus JPEG colorspace") JMESSAGE(JERR_BAD_LENGTH,
                                                "Bogus marker length") JMESSAGE(JERR_BAD_MCU_SIZE,
                                                                                "Sampling factors too large for interleaved scan")
              JMESSAGE(JERR_BAD_POOL_ID, "Invalid memory pool code %d") JMESSAGE(
                  JERR_BAD_PRECISION,
                  ...
                  JMESSAGE(JERR_BAD_SAMPLING, "Bogus sampling factors") JMESSAGE(
                      ...
                      "Invalid scan script at entry %d") JMESSAGE(JERR_BAD_STATE,
                                                                  ...
                                                                  "JPEG "
                                                                  "library in "
                                                                  "state %d") JMESSAGE(JERR_BAD_VIRTUAL_ACCESS,
                                                                                       "Bogus virtual array access") JMESSAGE(JERR_BUFFER_SIZE,
                                                                                                                              "Buffer passed to JPEG library is too small")
                      JMESSAGE(JERR_CANT_SUSPEND, "Suspension not allowed here") JMESSAGE(
                          JERR_CCIR601_NOTIMPL,
                          "CCIR601 sampling not implemented yet") JMESSAGE(JERR_COMPONENT_COUNT,
                                                                           "Too"
                                                                           " ma"
                                                                           "ny "
                                                                           "col"
                                                                           ...
                                                                           " ma"
                                                                           "x "
                                                                           "%d") JMESSAGE(JERR_CONVERSION_NOTIMPL,
                                                                                          "Unsupported color conversion request")
                          JMESSAGE(JERR_DAC_INDEX, "Bogus DAC index %d") JMESSAGE(
                              JERR_DAC_VALUE,
                              "Bogus DAC value 0x%x") JMESSAGE(JERR_DHT_COUNTS,
                                                               "Bogus DHT "
                                                               "counts")
                              JMESSAGE(JERR_DHT_INDEX, "Bogus DHT index %d") JMESSAGE(
                                  ...
                                  JMESSAGE(JERR_EMS_READ, "Read from EMS failed") JMESSAGE(
                                      ...
                                      "Write to EMS failed") JMESSAGE(JERR_EOI_EXPECTED,
                                                                      ...
                                                                      "than "
                                                                      "one "
                                                                      "scan") JMESSAGE(JERR_FILE_READ,
                                                                                       "Input file read error")
                                      JMESSAGE(
                                          JERR_FILE_WRITE,
                                          "Output file write error --- out of "
                                          "disk space?") JMESSAGE(JERR_FRACT_SAMPLE_NOTIMPL,
                                                                  "Fractional "
                                                                  "sampling "
                                                                  "not "
                                                                  "implemented "
                                                                  "yet") JMESSAGE(JERR_HUFF_CLEN_OVERFLOW,
                                                                                  "Huffman code size table overflow")
                                          JMESSAGE(
                                              JERR_HUFF_MISSING_CODE,
                                              "Missing Huffman code table "
                                              "entry") JMESSAGE(JERR_IMAGE_TOO_BIG,
                                                                "Maximum "
                                                                "supported "
                                                                "image "
                                                                "dimension is "
                                              ...
                                              JMESSAGE(JERR_INPUT_EOF,
                                                  ...
                                                  JMESSAGE(JERR_MISSING_DATA,
                                                      ...
                                                      JMESSAGE(
                                                          ...
                                                          "Requested feature "
                                                          "was omitted at "
                                                          "compile time") JMESSAGE(JERR_NO_BACKING_STORE,
                                                                                   "Backing store not supported")
                                                          JMESSAGE(
                                                              JERR_NO_HUFF_TABLE,
                                                              "Huffman table "
                                                              "0x%02x was not "
                                                              "defined") JMESSAGE(JERR_NO_IMAGE,
                                                                              ...
                                                                              JMESSAGE(
                                                                                  ...
                                                                                  JMESSAGE(
                                                                                      ...
                                                                                      JMESSAGE(JERR_XMS_WRITE,
                                                                                               "Write to XMS failed") JMESSAGE(JMSG_COPYRIGHT, JCOPYRIGHT) JMESSAGE(JMSG_VERSION, JVERSION) JMESSAGE(JTRC_16BIT_TABLES,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Obtained EMS handle %u") JMESSAGE(JTRC_EOI,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "End Of Image") JMESSAGE(JTRC_HUFFBITS,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "        %3d %3d %3d %3d %3d %3d %3d %3d") JMESSAGE(JTRC_JFIF,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "JFIF APP0 marker, density %dx%d  %d") JMESSAGE(JTRC_JFIF_BADTHUMBNAILSIZE,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "Warning: thumbnail image size does not match data length %u") JMESSAGE(JTRC_JFIF_MINOR,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "Unknown JFIF minor revision number %d.%02d") JMESSAGE(JTRC_JFIF_THUMBNAIL,
                                                                                                              ...
                                                                                                              JMESSAGE(
                                                                                                                  ...
                                                                                                                  "  Ss=%d, Se=%d, Ah=%d, Al=%d") JMESSAGE(JTRC_TFILE_CLOSE,
                                                                                                                                                           "Closed temporary file %s") JMESSAGE(JTRC_TFILE_OPEN,
                                                                                                                                                                                                "Opened temporary file %s") JMESSAGE(JTRC_UNKNOWN_IDS,
