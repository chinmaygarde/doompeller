...
class idRenderSystem {
 public:
  ...
  virtual void DrawSmallChar(int x,
                             int y,
                             int ch,
                             const idMaterial* material) = 0;
  virtual void DrawSmallStringExt(int x,
                                  ...
                                  bool forceColor,
                                  const idMaterial* material) = 0;
  virtual void DrawBigChar(int x,
                           int y,
                           int ch,
                           const idMaterial* material) = 0;
  ...
  virtual void CaptureRenderToFile(const char* fileName,
                                   bool fixAlpha = false) = 0;
...
// display
void R_LightProjectionMatrix(const idVec3& origin,
