...
typedef CGparameter (*PFNCGGETNAMEDPARAMETERPROC)(CGprogram prog,
                                                  const char* name);
typedef CGparameter (*PFNCGGETFIRSTPARAMETERPROC)(CGprogram prog,
                                                  CGenum name_space);
typedef CGparameter (*PFNCGGETNEXTPARAMETERPROC)(CGparameter current);
typedef CGparameter (*PFNCGGETFIRSTLEAFPARAMETERPROC)(CGprogram prog,
                                                      CGenum name_space);
...
typedef CGparameter (*PFNCGGETARRAYPARAMETERPROC)(CGparameter aparam,
                                                  int index);
...
typedef void (*PFNCGGLSETMATRIXPARAMETERDRPROC)(CGparameter param,
                                                const double* matrix);
typedef void (*PFNCGGLSETMATRIXPARAMETERFRPROC)(CGparameter param,
                                                const float* matrix);
typedef void (*PFNCGGLSETMATRIXPARAMETERDCPROC)(CGparameter param,
                                                const double* matrix);
typedef void (*PFNCGGLSETMATRIXPARAMETERFCPROC)(CGparameter param,
                                                const float* matrix);
typedef void (*PFNCGGLGETMATRIXPARAMETERDRPROC)(CGparameter param,
                                                double* matrix);
typedef void (*PFNCGGLGETMATRIXPARAMETERFRPROC)(CGparameter param,
                                                float* matrix);
typedef void (*PFNCGGLGETMATRIXPARAMETERDCPROC)(CGparameter param,
                                                double* matrix);
typedef void (*PFNCGGLGETMATRIXPARAMETERFCPROC)(CGparameter param,
                                                float* matrix);
...
typedef void (*PFNCGGLGETMATRIXPARAMETERARRAYDRPROC)(CGparameter param,
                                                     ...
                                                     long nelements,
                                                     double* matrices);
typedef void (*PFNCGGLSETTEXTUREPARAMETERPROC)(CGparameter param,
                                               GLuint texobj);
