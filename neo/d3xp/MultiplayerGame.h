...
class idMultiplayerGame {
 public:
...
#ifdef CTF
  void PlayTeamSound(int toTeam,
                     snd_evt_t evt,
                     const char* shader = NULL);  // sound that's sent only to
                                                  // member of toTeam team
#endif
  ...
  void ServerStartVote(int clientNum,
  ...
  void ProcessChatMessage(int clientNum,
                          bool team,
                          const char* name,
                          const char* text,
                          const char* sound);
 ...
 private:
  ...
  void UpdateRankColor(idUserInterface* gui,
                       const char* mask,
                       int i,
                       const idVec3& vec);
