...
class idWeapon : public idAnimatedEntity {
 public:
  ...
  bool GetGlobalJointTransform(bool viewModel,
  ...
  idEntity* DropItem(const idVec3& velocity,
                     int activateDelay,
                     int removeDelay,
                     bool died);
 ...
 private:
  ...
  bool powerAmmo;  // true if the clip reduction is a factor of the power
                   // setting when a projectile is launched
  // mp client
  bool isFiring;
  ...
  void Event_LaunchProjectiles(int num_projectiles,
                               float spread,
                               float fuseOffset,
                               float launchPower,
                               float dmgPower);
  ...
  void Event_LaunchProjectilesEllipse(int num_projectiles,
                                      float spreada,
                                      float spreadb,
                                      float fuseOffset,
                                      float power);
