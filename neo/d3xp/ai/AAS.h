...
class idAAS {
 public:
  ...
  virtual void ShowWalkPath(const idVec3& origin,
                            int goalAreaNum,
                            const idVec3& goalOrigin) const = 0;
  ...
  virtual bool FindNearestGoal(aasGoal_t& goal,
                               ...
                               int numObstacles,
                               idAASCallback& callback) const = 0;
};
