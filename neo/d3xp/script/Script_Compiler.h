...
class idCompiler {
 private:
  ...
  idVarDef* OptimizeOpcode(const opcode_t* op,
                           idVarDef* var_a,
                           idVarDef* var_b);
  ...
  idVarDef* FindImmediate(const idTypeDef* type,
                          const eval_t* eval,
                          const char* string) const;
  idVarDef* GetImmediate(idTypeDef* type,
                         const eval_t* eval,
                         const char* string);
  ...
  idVarDef* EmitFunctionParms(int op,
                              idVarDef* func,
                              int startarg,
                              int startsize,
                              idVarDef* object);
