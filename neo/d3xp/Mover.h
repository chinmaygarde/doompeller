...
class idMover : public idEntity {
 ...
 protected:
  ...
  //
  // mover directions.  make sure to change script/doom_defs.script if you add
 ...
 private:
  ...
  void Event_PostRestore(int start,
                         int total,
                         int accel,
                         int decel,
                         int useSplineAng);
...
class idMover_Binary : public idEntity {
 public:
  ...
  void Enable(bool b);
  void InitSpeed(idVec3& mpos1,
                 idVec3& mpos2,
                 float mspeed,
                 float maccelTime,
                 float mdecelTime);
  void InitTime(idVec3& mpos1,
                idVec3& mpos2,
                float mtime,
                float maccelTime,
                float mdecelTime);
