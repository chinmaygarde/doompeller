...
int curl_accept(int s, void* addr, void* addrlen, int line, const char* source);

/* FILE functions */
FILE* curl_fopen(const char* file,
                 const char* mode,
                 int line,
                 const char* source);
...
#define freeaddrinfo(data) curl_freeaddrinfo(data, __LINE__, __FILE__)
