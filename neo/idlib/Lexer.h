...
typedef enum {
  ...
  LEXFL_ALLOWIPADDRESSES =
      BIT(9),  // allow ip addresses to be parsed as numbers
  ...
  LEXFL_ONLYSTRINGS = BIT(13)  // parse as whitespace deliminated strings
                               // (quoted strings keep quotes)
} lexerFlags_t;
