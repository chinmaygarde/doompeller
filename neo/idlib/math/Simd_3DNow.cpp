...
#define BLOCK_PREFETCH_COPY \
  infinity  // no limit for movq/movntq w/block prefetch
#define CACHEBLOCK \
  80h  // number of 64-byte blocks (cache lines) for block prefetch
...
$memcpy_64_test:
	...
	jz		$memcpy_ic_2  // no more 64-byte blocks left
            ...
            // For larger blocks, which will spill beyond the cache, it's faster
            // to use the Streaming Store instruction MOVNTQ.   This write
            // instruction bypasses the cache and writes straight to main
            // memory.  This code also uses the software prefetch instruction to
            // pre-read the data.
align 16
...
$memcpy_bp_3:
	...
	jmp		$memcpy_bp_1  // keep processing chunks
            ...
            // optimized form which is an "unrolled loop".   Then it handles the
            // last few bytes.
align 4
	movsd
