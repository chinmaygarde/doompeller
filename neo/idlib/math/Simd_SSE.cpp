...
#define SHUFFLEPS(x, y, z, w) \
  (((x) & 3) << 6 | ((y) & 3) << 4 | ((z) & 3) << 2 | ((w) & 3))
#define R_SHUFFLEPS(x, y, z, w) \
...
============
*/
void VPCALL idSIMD_SSE::Dot(float* dst,
    ...
    */
    do {
      /*
         ...
         //  3,  X,  0,  1
      */
      xmm0 = _mm_load_ss((float*)(src_p + count_l4 + 1 * DRAWVERT_SIZE +
                                  DRAWVERT_XYZ_OFFSET + 0));  // 3,  X,  X,  X
      xmm2 = _mm_load_ss((float*)(src_p + count_l4 + 0 * DRAWVERT_SIZE +
                                  DRAWVERT_XYZ_OFFSET + 8));  // 2,  X,  X,  X
      xmm0 = _mm_loadh_pi(xmm0,
                          (__m64*)(src_p + count_l4 + 0 * DRAWVERT_SIZE +
                                   DRAWVERT_XYZ_OFFSET + 0));  // 3,  X,  0,  1
      xmm1 = xmm0;                                             // 3,  X,  0,  1
      ...
      /*
         ...
         //  2,  X,  4,  5
      */
      xmm1 = _mm_loadl_pi(xmm1,
                          (__m64*)(src_p + count_l4 + 1 * DRAWVERT_SIZE +
                                   DRAWVERT_XYZ_OFFSET + 4));  // 4,  5,  0,  1
      xmm2 =
          _mm_shuffle_ps(xmm2, xmm1, R_SHUFFLEPS(0, 1, 0, 1));  // 2,  X,  4,  5
      ...
      /*
         ...
         //  0,  3,  6,  9
      */
      xmm3 = _mm_load_ss((float*)(src_p + count_l4 + 3 * DRAWVERT_SIZE +
                                  DRAWVERT_XYZ_OFFSET + 0));  // 9,  X,  X,  X
      xmm3 = _mm_loadh_pi(xmm3,
                          (__m64*)(src_p + count_l4 + 2 * DRAWVERT_SIZE +
                                   DRAWVERT_XYZ_OFFSET + 0));  // 9,  X,  6,  7
      xmm0 =
          _mm_shuffle_ps(xmm0, xmm3, R_SHUFFLEPS(2, 0, 2, 0));  // 0,  3,  6,  9
                                                                /*
                                                                        movlps		xmm3,
                                                                   [esi+eax+3*DRAWVERT_SIZE+DRAWVERT_XYZ_OFFSET+4]	// 10, 11,  6,                                                           7
                                                                        shufps		xmm1, xmm3, R_SHUFFLEPS( 3, 0, 3, 0 )
                                                                   //  1,  4,  7, 10
                                                                */
      xmm3 = _mm_loadl_pi(xmm3,
                          (__m64*)(src_p + count_l4 + 3 * DRAWVERT_SIZE +
                                   DRAWVERT_XYZ_OFFSET + 4));  // 10, 11, 6,  7
      xmm1 =
          _mm_shuffle_ps(xmm1, xmm3, R_SHUFFLEPS(3, 0, 3, 0));  // 1,  4,  7, 10
      /*
              movhps		xmm3,
         [esi+eax+2*DRAWVERT_SIZE+DRAWVERT_XYZ_OFFSET+8]	// 10, 11,  8, X
              shufps		xmm2, xmm3, R_SHUFFLEPS( 0, 3, 2, 1 )
         //  2,  5,  8, 11
      */
      xmm3 = _mm_loadh_pi(xmm3,
                          (__m64*)(src_p + count_l4 + 2 * DRAWVERT_SIZE +
                                   DRAWVERT_XYZ_OFFSET + 8));  // 10, 11, 8,  X
      xmm2 =
          _mm_shuffle_ps(xmm2, xmm3, R_SHUFFLEPS(0, 3, 2, 1));  // 2,  5,  8, 11
...
============
*/
void VPCALL idSIMD_SSE::MinMax(idVec3& min,
                               idVec3& max,
                               const idDrawVert* src,
                               const int* indexes,
                               const int count) {
    ...
    */
    do {
      ...
      */
      ...
      xmm4 =
          _mm_loadh_pi(xmm4, (__m64*)(src_p + edx + DRAWVERT_XYZ_OFFSET + 0));
      ...
      */
      ...
      xmm5 =
          _mm_loadh_pi(xmm5, (__m64*)(src_p + edx + DRAWVERT_XYZ_OFFSET + 4));
      ...
      */
      ...
      xmm6 =
          _mm_loadh_pi(xmm6, (__m64*)(src_p + edx + DRAWVERT_XYZ_OFFSET + 0));
      ...
      */
      ...
      xmm7 =
          _mm_loadh_pi(xmm7, (__m64*)(src_p + edx + DRAWVERT_XYZ_OFFSET + 4));
...
#define TRANSPOSE_4x4(reg0, reg1, reg2, reg3, reg4)       \
  __asm movaps reg4,                                      \
      ...
      __asm shufps reg0,                                  \
      reg2,                                               \
      R_SHUFFLEPS(0, 1, 0, 1) /* reg0 =  0,  4,  8, 12 */ \
      __asm shufps reg1,                                  \
      reg2,                                               \
      R_SHUFFLEPS(2, 3, 2, 3) /* reg1 =  1,  5,  9, 13 */ \
      __asm movaps reg2,                                  \
      reg3 /* reg2 =  2,  6,  3,  7 */                    \
      __asm shufps reg2,                                  \
      reg4,                                               \
      R_SHUFFLEPS(0, 1, 0, 1) /* reg2 =  2,  6, 10, 14 */ \
      __asm shufps reg3,                                  \
      reg4, R_SHUFFLEPS(2, 3, 2, 3) /* reg3 =  3,  7, 11, 15 */
...
#define TRANPOSE_4x4_FROM_MEMORY(address, reg0, reg1, reg2, reg3, reg4) \
  __asm movlps reg1,                                                    \
      ...
      __asm shufps reg0,                                                \
      reg2,                                                             \
      R_SHUFFLEPS(0, 2, 0, 2) /* reg0 =  0,  4,  8, 12 */               \
      __asm shufps reg1,                                                \
      reg2,                                                             \
      R_SHUFFLEPS(1, 3, 1, 3) /* reg1 =  1,  5,  9, 13 */               \
      __asm movaps reg2,                                                \
      reg3 /* reg2 =  2,  3,  6,  7 */                                  \
      __asm shufps reg2,                                                \
      reg4,                                                             \
      R_SHUFFLEPS(0, 2, 0, 2) /* reg2 =  2,  6, 10, 14 */               \
      __asm shufps reg3,                                                \
      reg4, R_SHUFFLEPS(1, 3, 1, 3) /* reg3 =  3,  7, 11, 15 */
...
#define TRANSPOSE_4x3(reg0, reg1, reg2, reg3)             \
  __asm movaps reg3,                                      \
      ...
      __asm shufps reg3,                                  \
      reg1,                                               \
      R_SHUFFLEPS(2, 3, 0, 1) /* reg3 = 10, 11,  4,  5 */ \
      __asm shufps reg2,                                  \
      reg0,                                               \
      R_SHUFFLEPS(0, 1, 2, 3) /* reg2 =  8,  9,  2,  3 */ \
      __asm shufps reg1,                                  \
      reg0,                                               \
      R_SHUFFLEPS(2, 3, 0, 1) /* reg1 =  6,  7,  0,  1 */ \
      __asm movaps reg0,                                  \
      reg1 /* reg0 =  6,  7,  0,  1 */                    \
      __asm shufps reg0,                                  \
      reg2,                                               \
      ...
      __asm shufps reg1,                                  \
      reg3,                                               \
      R_SHUFFLEPS(3, 1, 2, 0) /* reg1 =  1,  7,  4, 10 */ \
      __asm shufps reg2,                                  \
      reg3, R_SHUFFLEPS(2, 0, 3, 1) /* reg2 =  2,  8,  5, 11 */
...
#define TRANSPOSE_4x3_FROM_MEMORY(address, reg0, reg1, reg2, reg3) \
  __asm movlps reg1,                                               \
      ...
      __asm shufps reg1,                                           \
      reg3,                                                        \
      R_SHUFFLEPS(1, 3, 0, 2) /* reg1 =  1,  7,  4, 10 */          \
      __asm shufps reg2,                                           \
      reg3, R_SHUFFLEPS(0, 2, 1, 3) /* reg2 =  2,  8,  5, 11 */
...
// with alignment
#define KFLOATINITS(SRC0, COUNT, PRE, POST) \
  KFLOATINITDSS(SRC0, SRC0, SRC0, COUNT, PRE, POST)
#define KFLOATINITD(DST, COUNT, PRE, POST) \
  KFLOATINITDSS(DST, DST, DST, COUNT, PRE, POST)
#define KFLOATINITDS(DST, SRC0, COUNT, PRE, POST) \
  KFLOATINITDSS(DST, SRC0, SRC0, COUNT, PRE, POST)

#define KFLOATINITDSS(DST, SRC0, SRC1, COUNT, PRE, POST)                      \
  __asm mov ecx, DST __asm shr ecx, 2 __asm mov ebx,                          \
      COUNT __asm neg ecx __asm mov edx, SRC0 __asm and ecx, 3 __asm mov esi, \
      SRC1 __asm sub ebx, ecx __asm jge noUnderFlow __asm xor ebx,            \
      ebx __asm mov ecx,                                                      \
      COUNT __asm noUnderFlow : __asm mov PRE,                                \
                                ecx __asm mov eax,                            \
                                ebx __asm mov edi,                            \
                                DST __asm and eax,                            \
                                8 - 1 __asm mov POST,                         \
                                eax __asm and ebx,                            \
                                0xfffffff8 __asm jle done __asm shl ebx,      \
                                2 __asm lea ecx,                              \
                                [ecx * 4 + ebx] __asm neg ebx __asm add edx,  \
                                ecx __asm add esi,                            \
                                ecx __asm add edi,                            \
                                ecx __asm mov eax,                            \
                                edx __asm or eax,                             \
...
#define KFLOATINITS_NA(SRC0, COUNT, PRE, POST) \
  KFLOATINITDSS_NA(SRC0, SRC0, SRC0, COUNT, PRE, POST)
#define KFLOATINITD_NA(DST, COUNT, PRE, POST) \
  KFLOATINITDSS_NA(DST, DST, DST, COUNT, PRE, POST)
#define KFLOATINITDS_NA(DST, SRC0, COUNT, PRE, POST) \
  KFLOATINITDSS_NA(DST, SRC0, SRC0, COUNT, PRE, POST)
#define KFLOATINITDSS_NA(DST, SRC0, SRC1, COUNT, PRE, POST)                 \
  __asm mov eax, COUNT __asm mov PRE, 0 __asm and eax, 8 - 1 __asm mov ebx, \
      COUNT __asm mov POST, eax __asm and ebx,                              \
      0xfffffff8 __asm je done __asm shl ebx, 2 __asm mov edx,              \
      SRC0 __asm mov esi, SRC1 __asm mov edi, DST __asm add edx,            \
      ebx __asm add esi, ebx __asm add edi, ebx __asm mov eax,              \
      edx __asm or eax, esi __asm or eax, edi __asm neg ebx
...
#define KMINDS1(DST, SRC0) __asm movss xmm2, SRC0 __asm minss DST, xmm2
#define KMAXDS1(DST, SRC0) __asm movss xmm2, SRC0 __asm maxss DST, xmm2
...
#define KALUDSS4(OP, DST, SRC0, SRC1)                                \
  __asm movups xmm2, SRC0 __asm movups xmm3, SRC1 __asm OP##ps xmm2, \
      xmm3 __asm movups DST, xmm2
...
#define KDIVDSS1(DST, SRC0, SRC1)                                          \
  __asm movss xmm2, SRC1 __asm rcpss xmm3, xmm2 __asm mulss xmm2,          \
      xmm3 __asm mulss xmm2, xmm3 __asm addss xmm3, xmm3 __asm subss xmm3, \
      xmm2 __asm mulss xmm3, SRC0 __asm movss DST, xmm3
#define KDIVDSS4(DST, SRC0, SRC1)                                           \
  __asm movups xmm2, SRC1 __asm rcpps xmm3, xmm2 __asm mulps xmm2,          \
      xmm3 __asm mulps xmm2, xmm3 __asm addps xmm3, xmm3 __asm subps xmm3,  \
      xmm2 __asm movups xmm2, SRC0 __asm mulps xmm3, xmm2 __asm movups DST, \
      xmm3
#define KF2IDS1(SRC0) \
  __asm movss xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movd[edi + ebx], mm2
#define KF2IDS4(SRC0)                                                          \
  __asm movups xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 0], \
      mm2 __asm shufps xmm2, xmm2, SHUFFLEPS(1, 0, 3, 2) __asm cvttps2pi mm2,  \
      xmm2 __asm movq[edi + ebx + 8], mm2
#define KISQRTDS1(DST, SRC0)                                               \
  __asm movss xmm2, SRC0 __asm rsqrtss xmm3, xmm2 __asm mulss xmm2,        \
      xmm3 __asm mulss xmm2, xmm3 __asm subss xmm2, xmm1 __asm mulss xmm3, \
      xmm0 __asm mulss xmm3, xmm2 __asm movss DST, xmm3
#define KISQRTDS4(DST, SRC0)                                               \
  __asm movups xmm2, SRC0 __asm rsqrtps xmm3, xmm2 __asm mulps xmm2,       \
      xmm3 __asm mulps xmm2, xmm3 __asm subps xmm2, xmm1 __asm mulps xmm3, \
      xmm0 __asm mulps xmm3, xmm2 __asm movups DST, xmm3

// this is used in vector4 implementation to shift constant V4
#define KANDREGDSV(DST, SRC0, VALUE) __asm mov DST, SRC0 __asm and DST, VALUE

// this is used in vector4 code to operate with float arrays as sources
#define KEXPANDFLOAT(DST, SRC) __asm movss DST, SRC __asm shufps DST, DST, 0
...
#define KFLOATOPER(OPER, OPER4, COUNT)                                        \
  __asm mov ecx, pre __asm mov ebx, COUNT __asm cmp ebx, ecx __asm cmovl ecx, \
      COUNT __asm test ecx, ecx __asm je preDone __asm xor ebx,               \
      ebx __asm lpPre : OPER __asm add ebx,                                   \
                        4 __asm dec ecx __asm jg lpPre __asm preDone          \
      : __asm mov ecx,                                                        \
        post __asm mov ebx,                                                   \
        COUNT __asm sub ebx,                                                  \
        ecx __asm shl ebx,                                                    \
        2 __asm cmp ecx,                                                      \
        4 __asm jl post4Done OPER4 __asm sub ecx,                             \
        4 __asm add ebx,                                                      \
        4 * 4 __asm post4Done : __asm test ecx,                               \
        ecx __asm je postDone __asm lpPost                                    \
      : OPER __asm add ebx,                                                   \
        4 __asm dec ecx __asm jg lpPost __asm postDone:

// operate on a constant and a float array
#define KFLOAT_CA(ALUOP, DST, SRC, CONSTANT, COUNT)                  \
  int pre, post;                                                     \
  __asm movss xmm0, CONSTANT __asm shufps xmm0, xmm0,                \
      0 KFLOATINITDS(DST, SRC, COUNT, pre, post) __asm and eax,      \
      15 __asm jne lpNA __asm jmp lpA __asm align 16 __asm lpA       \
      : __asm prefetchnta[edx + ebx + 64] __asm movaps xmm1,         \
        xmm0 __asm movaps xmm2,                                      \
        xmm0 __asm ALUOP##ps xmm1,                                   \
        [edx + ebx] __asm ALUOP##ps xmm2,                            \
        [edx + ebx + 16] __asm movaps[edi + ebx],                    \
        xmm1 __asm movaps[edi + ebx + 16],                           \
        xmm2 __asm add ebx,                                          \
        16 * 2 __asm jl lpA __asm jmp done __asm align 16 __asm lpNA \
      : __asm prefetchnta[edx + ebx + 64] __asm movaps xmm1,         \
        xmm0 __asm movaps xmm2,                                      \
        xmm0 __asm movups xmm3,                                      \
        [edx + ebx] __asm movups xmm4,                               \
        [edx + ebx + 16] __asm ALUOP##ps xmm1,                       \
        xmm3 __asm ALUOP##ps xmm2,                                   \
        xmm4 __asm movaps[edi + ebx],                                \
        xmm1 __asm movaps[edi + ebx + 16],                           \
        xmm2 __asm add ebx,                                          \
        16 * 2 __asm jl lpNA __asm done : __asm mov edx,             \
        SRC __asm mov edi,                                           \
        DST __asm KFLOATOPER(                                        \
            KALUDSS1(ALUOP, [edi + ebx], xmm0, [edx + ebx]),         \
...
#define KFLOAT_AA(ALUOP, DST, SRC0, SRC1, COUNT)                               \
  ...
  __asm and eax,                                                               \
      15 __asm jne lpNA __asm jmp lpA __asm align 16 __asm lpA                 \
      : __asm movaps xmm1,                                                     \
        [edx + ebx] __asm movaps xmm2,                                         \
        [edx + ebx + 16] __asm ALUOP##ps xmm1,                                 \
        [esi + ebx] __asm ALUOP##ps xmm2,                                      \
        [esi + ebx +                                                           \
         16] __asm prefetchnta[edx + ebx +                                     \
                               64] __asm prefetchnta[esi + ebx +               \
                                                     64] __asm movaps[edi +    \
                                                                      ebx],    \
        xmm1 __asm movaps[edi + ebx + 16],                                     \
        xmm2 __asm add ebx,                                                    \
        16 * 2 __asm jl lpA __asm jmp done __asm align 16 __asm lpNA           \
      : __asm movups xmm1,                                                     \
        [edx + ebx] __asm movups xmm2,                                         \
        [edx + ebx + 16] __asm movups xmm3,                                    \
        [esi + ebx] __asm movups xmm4,                                         \
        [esi + ebx +                                                           \
         16] __asm prefetchnta[edx + ebx +                                     \
                               64] __asm prefetchnta[esi + ebx +               \
                                                     64] __asm ALUOP##ps xmm1, \
        xmm3 __asm ALUOP##ps xmm2,                                             \
        xmm4 __asm movaps[edi + ebx],                                          \
        xmm1 __asm movaps[edi + ebx + 16],                                     \
        xmm2 __asm add ebx,                                                    \
        ...
        KFLOATOPER(KALUDSS1(ALUOP, [edi + ebx], [edx + ebx], [esi + ebx]),     \
                   KALUDSS4(ALUOP, [edi + ebx], [edx + ebx], [esi + ebx]),     \
                   COUNT)
...
#define ALIGN8_INIT1(X, INIT) \
  ALIGN16(static X[8]) = {INIT, INIT, INIT, INIT, INIT, INIT, INIT, INIT}

ALIGN8_INIT1(unsigned short SIMD_W_zero, 0);
ALIGN8_INIT1(unsigned short SIMD_W_maxShort, 1 << 15);

ALIGN4_INIT1(unsigned long SIMD_DW_mat2quatShuffle0,
             (3 << 0) | (2 << 8) | (1 << 16) | (0 << 24));
ALIGN4_INIT1(unsigned long SIMD_DW_mat2quatShuffle1,
             (0 << 0) | (1 << 8) | (2 << 16) | (3 << 24));
ALIGN4_INIT1(unsigned long SIMD_DW_mat2quatShuffle2,
             (1 << 0) | (0 << 8) | (3 << 16) | (2 << 24));
ALIGN4_INIT1(unsigned long SIMD_DW_mat2quatShuffle3,
             (2 << 0) | (3 << 8) | (0 << 16) | (1 << 24));

ALIGN4_INIT4(unsigned long SIMD_SP_singleSignBitMask,
             (unsigned long)(1 << 31),
             0,
             0,
             0);
...
float SSE_ATan(float y, float x) {
  ...
  if (fabs(y) > fabs(x)) {
    ...
    d = idMath::HALF_PI;
    *((unsigned long*)&d) ^=
        (*((unsigned long*)&x) ^ *((unsigned long*)&y)) & (1 << 31);
  } else {
    a = y / x;
    d = 0.0f;
  }
...
============
*/
void VPCALL idSIMD_SSE::Add(float* dst,
...
============
*/
void VPCALL idSIMD_SSE::Sub(float* dst,
                            const float constant,
                            const float* src,
                            const int count) {
...
============
*/
void VPCALL idSIMD_SSE::Mul(float* dst,
                            const float constant,
                            const float* src,
                            const int count) {
...
============
*/
void VPCALL idSIMD_SSE::Div(float* dst,
                            const float constant,
                            const float* src,
                            const int count) {
  int pre, post;
...
============
*/
static void Simd_MulAdd(float* dst,
                        const float constant,
                        const float* src,
                        const int count) {
  __asm mov esi, dst __asm mov edi, src __asm mov eax, count __asm shl eax,
      2 __asm mov ecx, esi __asm mov edx, eax __asm or ecx,
      edi __asm fld constant __asm and ecx,
      15 __asm jz SimdMulAdd16 __asm and ecx,
      3 __asm jnz SimdMulAdd8 __asm mov ecx, esi __asm xor ecx,
      edi __asm and ecx, 15 __asm jnz MulAdd8 __asm mov ecx, esi __asm and ecx,
      15 __asm neg ecx __asm add ecx, 16 __asm sub eax, ecx __asm add edi,
      ecx __asm add esi, ecx __asm neg ecx __asm mov edx,
      eax __asm loopPreMulAdd16
      : __asm fld st __asm fmul dword ptr[edi + ecx] __asm fadd dword
            ptr[esi + ecx] __asm fstp dword ptr[esi + ecx] __asm add ecx,
        4 __asm jl loopPreMulAdd16 __asm SimdMulAdd16
      : __asm and eax,
        ~15 __asm movss xmm1,
        constant __asm shufps xmm1,
        xmm1,
        0x00 __asm add esi,
        eax __asm add edi,
        eax __asm neg eax __asm align 16 __asm loopMulAdd16
      : __asm movaps xmm0,
        [edi + eax] __asm mulps xmm0,
        xmm1 __asm addps xmm0,
        [esi + eax] __asm movaps[esi + eax],
        xmm0 __asm add eax,
        16 __asm jl loopMulAdd16 __asm jmp postMulAdd __asm MulAdd8
      : __asm mov ecx,
        esi __asm and ecx,
        7 __asm jz SimdMulAdd8 __asm sub eax,
        ecx __asm add esi,
        ecx __asm add edi,
        ecx __asm neg ecx __asm mov edx,
        eax __asm loopPreMulAdd8
      : __asm fld st __asm fmul dword ptr[edi + ecx] __asm fadd dword
            ptr[esi + ecx] __asm fstp dword ptr[esi + ecx] __asm add ecx,
        4 __asm jl loopPreMulAdd8 __asm SimdMulAdd8
      : __asm and eax,
        ~15 __asm movss xmm1,
        constant __asm shufps xmm1,
        xmm1,
        0x00 __asm add esi,
        eax __asm add edi,
        eax __asm neg eax __asm align 16 __asm loopMulAdd8
      : __asm movlps xmm0,
        [edi + eax] __asm movhps xmm0,
        [edi + eax + 8] __asm mulps xmm0,
        xmm1 __asm movlps xmm2,
        [esi + eax] __asm movhps xmm2,
        [esi + eax + 8] __asm addps xmm0,
        xmm2 __asm movlps[esi + eax],
        xmm0 __asm movhps[esi + eax + 8],
        xmm0 __asm add eax,
        16 __asm jl loopMulAdd8 __asm jmp postMulAdd __asm postMulAdd
      : __asm and edx,
        15 __asm jz MulAddDone __asm add esi,
        edx __asm add edi,
        edx __asm neg edx __asm loopPostMulAdd
      : __asm fld st __asm fmul dword ptr[edi + edx] __asm fadd dword
            ptr[esi + edx] __asm fstp dword ptr[esi + edx] __asm add edx,
        4 __asm jl loopPostMulAdd __asm MulAddDone : __asm fstp st
}
...
============
*/
void VPCALL idSIMD_SSE::MulAdd(float* dst,
                               const float constant,
                               const float* src,
                               const int count) {
  float c = constant;
...
============
*/
void VPCALL idSIMD_SSE::MulSub(float* dst,
                               const float constant,
                               const float* src,
                               const int count) {
  float c = constant;
...
#define SINGLE_OP(SRC, DEST)                                                \
  __asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm mulps xmm0,   \
      xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm movaps xmm1, \
      xmm0 __asm shufps xmm1, xmm1, SHUFFLEPS(1, 1, 1, 1) __asm addss xmm0, \
      xmm1 __asm movss[DEST], xmm0 __asm add SRC, 16 __asm add DEST, 4

#define DUAL_OP(SRC, DEST)                                                  \
  __asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm movhps xmm0,  \
      [SRC + 16] __asm movhps xmm1, [SRC + 24] __asm mulps xmm0,            \
      xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm shufps xmm1, \
      xmm0, SHUFFLEPS(2, 0, 1, 0) __asm shufps xmm0, xmm0,                  \
      SHUFFLEPS(3, 1, 2, 0) __asm addps xmm0, xmm1 __asm movhps[DEST],      \
      xmm0 __asm add SRC, 32 __asm add DEST, 8
...
============
*/
void VPCALL idSIMD_SSE::Dot(float& dot,
                            const float* src1,
                            const float* src2,
                            const int count) {
  switch (count) {
...
#define COMPARECONSTANT(DST, SRC0, CONSTANT, COUNT, CMP, CMPSIMD, DOFLIP)  \
  ...
  if (((int)SRC0) & 3) {                                                   \
    ...
    cnt = COUNT >> 2;                                                      \
    post = COUNT - (cnt << 2);                                             \
    __asm mov edx, cnt __asm test edx,                                     \
        edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi,   \
        SRC0 __asm prefetchnta[esi + 64] __asm movss xmm1,                 \
        CONSTANT __asm shufps xmm1, xmm1,                                  \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm mov ecx,          \
        0x01010101 __asm loopNA                                            \
        : __asm movups xmm0,                                               \
          [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0,           \
          xmm1 __asm movmskps eax,                                         \
          xmm0 __asm DOFLIP __asm mov ah,                                  \
          al __asm shr ah,                                                 \
          1 __asm mov bx,                                                  \
          ax __asm shl ebx,                                                \
          14 __asm mov bx,                                                 \
          ax __asm and ebx,                                                \
          ecx __asm mov dword ptr[edi],                                    \
          ebx __asm add esi,                                               \
          16 __asm add edi,                                                \
          4 __asm inc edx __asm jl loopNA __asm pop ebx                    \
  } else {                                                                 \
    ...
    if ((int)aligned > ((int)src0) + COUNT) {                              \
      ...
      __asm mov edx, cnt __asm test edx,                                   \
          edx __asm je doneCmp __asm push ebx __asm neg edx __asm mov esi, \
          aligned __asm prefetchnta[esi + 64] __asm movss xmm1,            \
          CONSTANT __asm shufps xmm1, xmm1,                                \
          R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm add edi,        \
          pre __asm mov ecx,                                               \
          0x01010101 __asm loopA                                           \
          : __asm movaps xmm0,                                             \
            [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0,         \
            xmm1 __asm movmskps eax,                                       \
            xmm0 __asm DOFLIP __asm mov ah,                                \
            ...
            ebx __asm add esi,                                             \
            16 __asm add edi,                                              \
            4 __asm inc edx __asm jl loopA __asm pop ebx                   \
    }                                                                      \
  }                                                                        \
  doneCmp:                                                                 \
  double c = constant;                                                     \
...
#define COMPAREBITCONSTANT(DST, BITNUM, SRC0, CONSTANT, COUNT, CMP, CMPSIMD, \
                           DOFLIP)                                           \
  int i, cnt, pre, post;                                                     \
  float* aligned;                                                            \
                                                                             \
  ...
  if (((int)SRC0) & 3) {                                                     \
    ...
    __asm mov edx, cnt __asm test edx,                                       \
        ...
        SRC0 __asm prefetchnta[esi + 64] __asm movss xmm1,                   \
        CONSTANT __asm shufps xmm1, xmm1,                                    \
        R_SHUFFLEPS(0, 0, 0, 0) __asm mov edi, DST __asm mov cl,             \
        bitNum __asm loopNA                                                  \
        : __asm movups xmm0,                                                 \
          [esi] __asm prefetchnta[esi + 128] __asm CMPSIMD xmm0,             \
          xmm1 __asm movmskps eax,                                           \
          ...
          14 __asm mov bx,                                                   \
          ax __asm and ebx,                                                  \
          0x01010101 __asm shl ebx,                                          \
          cl __asm or ebx,                                                   \
          dword ptr[edi] __asm mov dword ptr[edi],                           \
          ebx __asm add esi,                                                 \
          16 __asm add edi,                                                  \
          4 __asm inc edx __asm jl loopNA __asm pop ebx                      \
  } else {                                                                   \
...
============
*/
void VPCALL idSIMD_SSE::CmpGT(byte* dst,
                              const float* src0,
                              const float constant,
                              const int count) {
...
============
*/
void VPCALL idSIMD_SSE::CmpGE(byte* dst,
                              const float* src0,
                              const float constant,
                              const int count) {
...
============
*/
void VPCALL idSIMD_SSE::CmpLT(byte* dst,
                              const float* src0,
                              const float constant,
                              const int count) {
...
============
*/
void VPCALL idSIMD_SSE::CmpLE(byte* dst,
                              const float* src0,
                              const float constant,
                              const int count) {
...
============
*/
void VPCALL idSIMD_SSE::MinMax(float& min,
                               float& max,
                               const float* src,
                               const int count) {
  int i, pre, post;
...
============
*/
void VPCALL idSIMD_SSE::MinMax(idVec2& min,
                               idVec2& max,
                               const idVec2* src,
                               const int count) {
  __asm {
...
void VPCALL idSIMD_SSE::MinMax(idVec3& min,
  ...
  __asm {
	...
	loop4:
        //		prefetchnta
        //[esi+4*DRAWVERT_SIZE+DRAWVERT_XYZ_OFFSET]
...
============
*/
void VPCALL idSIMD_SSE::Clamp(float* dst,
                              const float* src,
                              const float min,
                              const float max,
                              const int count) {
...
============
*/
void VPCALL idSIMD_SSE::ClampMin(float* dst,
                                 const float* src,
                                 const float min,
                                 const int count) {
  int i, pre, post;
...
============
*/
void VPCALL idSIMD_SSE::ClampMax(float* dst,
                                 const float* src,
                                 const float max,
                                 const int count) {
  int i, pre, post;
...
============
*/
void VPCALL idSIMD_SSE::Add16(float* dst,
                              const float* src1,
                              const float* src2,
                              const int count) {
  __asm {
...
============
*/
void VPCALL idSIMD_SSE::Sub16(float* dst,
                              const float* src1,
                              const float* src2,
                              const int count) {
  __asm {
...
============
*/
void VPCALL idSIMD_SSE::Mul16(float* dst,
                              const float* src1,
                              const float constant,
                              const int count) {
  __asm {
...
============
*/
void VPCALL idSIMD_SSE::AddAssign16(float* dst,
                                    const float* src,
                                    const int count) {
  __asm {
		mov		ecx, dst
...
============
*/
void VPCALL idSIMD_SSE::SubAssign16(float* dst,
                                    const float* src,
                                    const int count) {
  __asm {
		mov		ecx, dst
...
============
*/
void VPCALL idSIMD_SSE::MulAssign16(float* dst,
                                    const float constant,
                                    const int count) {
  __asm {
		mov		ecx, dst
...
============
*/
void VPCALL idSIMD_SSE::MatX_MultiplyVecX(idVecX& dst,
                                          const idMatX& mat,
                                          const idVecX& vec) {
#define STORE1(offset, reg1, reg2) __asm movss[eax + offset], reg1
#define STORE2LO(offset, reg1, reg2) __asm movlps[eax + offset], reg1
#define STORE2HI(offset, reg1, reg2) __asm movhps[eax + offset], reg1
    ...
    case 5: {
      switch (numRows) {
        ...
        default: {
          for (int i = 0; i < numRows; i++) {
            dstPtr[i] STOREC mPtr[0] * vPtr[0] + mPtr[1] * vPtr[1] +
                mPtr[2] * vPtr[2] + mPtr[3] * vPtr[3] + mPtr[4] * vPtr[4];
            mPtr += 5;
          }
          return;
        }
...
============
*/
void VPCALL idSIMD_SSE::MatX_MultiplyAddVecX(idVecX& dst,
                                             const idMatX& mat,
                                             const idVecX& vec) {
#define STORE1(offset, reg1, reg2)                   \
  __asm movss reg2, [eax + offset] __asm addss reg2, \
      reg1 __asm movss[eax + offset], reg2
#define STORE2LO(offset, reg1, reg2)                  \
  __asm movlps reg2, [eax + offset] __asm addps reg2, \
      reg1 __asm movlps[eax + offset], reg2
#define STORE2HI(offset, reg1, reg2)                  \
  __asm movhps reg2, [eax + offset] __asm addps reg2, \
      reg1 __asm movhps[eax + offset], reg2
#define STORE4(offset, reg1, reg2)                                          \
  __asm movlps reg2, [eax + offset] __asm movhps reg2,                      \
      [eax + offset + 8] __asm addps reg2, reg1 __asm movlps[eax + offset], \
      reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC +=
...
============
*/
void VPCALL idSIMD_SSE::MatX_MultiplySubVecX(idVecX& dst,
                                             const idMatX& mat,
                                             const idVecX& vec) {
#define STORE1(offset, reg1, reg2)                   \
  __asm movss reg2, [eax + offset] __asm subss reg2, \
      reg1 __asm movss[eax + offset], reg2
#define STORE2LO(offset, reg1, reg2)                  \
  __asm movlps reg2, [eax + offset] __asm subps reg2, \
      reg1 __asm movlps[eax + offset], reg2
#define STORE2HI(offset, reg1, reg2)                  \
  __asm movhps reg2, [eax + offset] __asm subps reg2, \
      reg1 __asm movhps[eax + offset], reg2
#define STORE4(offset, reg1, reg2)                                          \
  __asm movlps reg2, [eax + offset] __asm movhps reg2,                      \
      [eax + offset + 8] __asm subps reg2, reg1 __asm movlps[eax + offset], \
      reg2 __asm movhps[eax + offset + 8], reg2
#define STOREC -=
...
============
*/
void VPCALL idSIMD_SSE::MatX_TransposeMultiplyVecX(idVecX& dst,
                                                   const idMatX& mat,
                                                   const idVecX& vec) {
#define STORE1(offset, reg1, reg2) __asm movss[eax + offset], reg1
#define STORE2LO(offset, reg1, reg2) __asm movlps[eax + offset], reg1
...
============
*/
void VPCALL idSIMD_SSE::MatX_TransposeMultiplyAddVecX(idVecX& dst,
                                                      const idMatX& mat,
                                                      const idVecX& vec) {
#define STORE1(offset, reg1, reg2)                   \
  __asm movss reg2, [eax + offset] __asm addss reg2, \
...
============
*/
void VPCALL idSIMD_SSE::MatX_TransposeMultiplySubVecX(idVecX& dst,
                                                      const idMatX& mat,
                                                      const idVecX& vec) {
#define STORE1(offset, reg1, reg2)                   \
  __asm movss reg2, [eax + offset] __asm subss reg2, \
...
============
*/
void VPCALL idSIMD_SSE::MatX_MultiplyMatX(idMatX& dst,
                                          const idMatX& m1,
                                          const idMatX& m2) {
  int i, j, k, l, n;
  float* dstPtr;
...
#define MUL_Nx2_2x6_INIT                                          \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,        \
      dstPtr __asm movaps xmm0, [esi] __asm movlps xmm1,          \
      [esi + 16] __asm movhps xmm1, [esi + 40] __asm movlps xmm2, \
      [esi + 24] __asm movhps xmm2, [esi + 32]

#define MUL_Nx2_2x6_ROW2(row)                                                  \
  __asm movaps xmm3, [edi + row * 16] __asm movaps xmm5,                       \
      xmm0 __asm movaps xmm4, xmm3 __asm shufps xmm4, xmm4,                    \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm movaps xmm4,        \
      xmm3 __asm movaps xmm6, xmm2 __asm shufps xmm4, xmm4,                    \
      R_SHUFFLEPS(1, 1, 1, 1) __asm mulps xmm6, xmm4 __asm addps xmm5,         \
      xmm6 __asm movaps[eax + row * 48], xmm5 __asm movaps xmm4,               \
      xmm3 __asm shufps xmm4, xmm4, R_SHUFFLEPS(0, 0, 1, 1) __asm movaps xmm7, \
      xmm1 __asm mulps xmm7, xmm4 __asm movaps xmm4, xmm3 __asm movaps xmm5,   \
      xmm0 __asm shufps xmm4, xmm4, R_SHUFFLEPS(2, 2, 2, 2) __asm mulps xmm5,  \
      xmm4 __asm movaps xmm4, xmm3 __asm movaps xmm6, xmm2 __asm shufps xmm4,  \
      xmm4, R_SHUFFLEPS(3, 3, 3, 3) __asm mulps xmm6, xmm4 __asm addps xmm5,   \
      xmm6 __asm shufps xmm3, xmm3, R_SHUFFLEPS(2, 2, 3, 3) __asm movaps xmm6, \
      xmm1 __asm mulps xmm6, xmm3 __asm movaps xmm4, xmm7 __asm movlhps xmm7,  \
      xmm6 __asm movhlps xmm6, xmm4 __asm addps xmm6,                          \
      xmm7 __asm movlps[eax + row * 48 + 16],                                  \
      xmm6 __asm movlps[eax + row * 48 + 24],                                  \
      xmm5 __asm movhps[eax + row * 48 + 32],                                  \
      xmm5 __asm movhps[eax + row * 48 + 40], xmm6

            MUL_Nx2_2x6_INIT MUL_Nx2_2x6_ROW2(0)

                return;
          }
          case 6: {  // 6x2 * 2x6

            MUL_Nx2_2x6_INIT MUL_Nx2_2x6_ROW2(0) MUL_Nx2_2x6_ROW2(1)
                MUL_Nx2_2x6_ROW2(2)
...
#define MUL_Nx3_3x6_FIRST4COLUMNS_INIT                                   \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,               \
      dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0,         \
      [esi + 2 * 4] __asm movlps xmm1, [esi + 6 * 4] __asm movhps xmm1,  \
      [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2, \
      [esi + 14 * 4]

#define MUL_Nx3_3x6_FIRST4COLUMNS_ROW(row)                                   \
  __asm movss xmm3, [edi + (row * 3 + 0) * 4] __asm shufps xmm3, xmm3,       \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm3,                              \
      xmm0 __asm movss xmm4, [edi + (row * 3 + 1) * 4] __asm shufps xmm4,    \
      xmm4, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm4, xmm1 __asm addps xmm3, \
      xmm4 __asm movss xmm5, [edi + (row * 3 + 2) * 4] __asm shufps xmm5,    \
      xmm5, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm3, \
      xmm5 __asm movlps[eax + (row * 6 + 0) * 4],                            \
      xmm3 __asm movhps[eax + (row * 6 + 2) * 4], xmm3

#define MUL_Nx3_3x6_LAST2COLUMNS_ROW6                                       \
  __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1,                       \
      [esi + 10 * 4] __asm movlps xmm2, [esi + 16 * 4] __asm shufps xmm0,   \
      xmm0, 0x44 __asm shufps xmm1, xmm1, 0x44 __asm shufps xmm2, xmm2,     \
      0x44 __asm movlps xmm3, [edi + 0 * 4] __asm movhps xmm3,              \
      [edi + 2 * 4] __asm movaps xmm4, xmm3 __asm movaps xmm5,              \
      xmm3 __asm shufps xmm3, xmm3, 0xF0 __asm mulps xmm3,                  \
      xmm0 __asm movlps xmm6, [edi + 4 * 4] __asm movhps xmm6,              \
      [edi + 6 * 4] __asm shufps xmm4, xmm6, 0x05 __asm mulps xmm4,         \
      xmm1 __asm addps xmm3, xmm4 __asm shufps xmm5, xmm6,                  \
      0x5A __asm mulps xmm5, xmm2 __asm addps xmm3,                         \
      xmm5 __asm movlps[eax + 4 * 4], xmm3 __asm movhps[eax + 10 * 4],      \
      xmm3 __asm movaps xmm5, xmm6 __asm movlps xmm3,                       \
      [edi + 8 * 4] __asm movhps xmm3, [edi + 10 * 4] __asm movaps xmm4,    \
      xmm3 __asm shufps xmm5, xmm3, 0x5A __asm mulps xmm5,                  \
      xmm0 __asm shufps xmm6, xmm3, 0xAF __asm mulps xmm6,                  \
      xmm1 __asm addps xmm5, xmm6 __asm shufps xmm4, xmm4,                  \
      0xF0 __asm mulps xmm4, xmm2 __asm addps xmm4,                         \
      xmm5 __asm movlps[eax + 16 * 4], xmm4 __asm movhps[eax + 22 * 4],     \
      xmm4 __asm movlps xmm6, [edi + 12 * 4] __asm movhps xmm6,             \
      [edi + 14 * 4] __asm movaps xmm5, xmm6 __asm movaps xmm4,             \
      xmm6 __asm shufps xmm6, xmm6, 0xF0 __asm mulps xmm6,                  \
      xmm0 __asm movlps xmm3, [edi + 16 * 4] __asm shufps xmm5, xmm3,       \
      0x05 __asm mulps xmm5, xmm1 __asm addps xmm5, xmm6 __asm shufps xmm4, \
      xmm3, 0x5A __asm mulps xmm4, xmm2 __asm addps xmm4,                   \
      xmm5 __asm movlps[eax + 28 * 4], xmm4 __asm movhps[eax + 34 * 4], xmm4

            MUL_Nx3_3x6_FIRST4COLUMNS_INIT MUL_Nx3_3x6_FIRST4COLUMNS_ROW(0)
...
#define MUL_Nx4_4x6_FIRST4COLUMNS_INIT                                    \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                \
      ...
      [esi + 2 * 4] __asm movlps xmm1, [esi + 6 * 4] __asm movhps xmm1,   \
      [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2,  \
      [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, \
      [esi + 20 * 4]

#define MUL_Nx4_4x6_FIRST4COLUMNS_ROW(row)                                     \
  __asm movss xmm4, [edi + row * 16 + 0 * 4] __asm shufps xmm4, xmm4,          \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm4,                                \
      xmm0 __asm movss xmm5, [edi + row * 16 + 1 * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm1 __asm addps xmm4,         \
      xmm5 __asm movss xmm6, [edi + row * 16 + 2 * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm4,         \
      xmm6 __asm movss xmm7, [edi + row * 16 + 3 * 4] __asm shufps xmm7, xmm7, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7, xmm3 __asm addps xmm4,         \
      xmm7 __asm movlps[eax + row * 24 + 0],                                   \
      xmm4 __asm movhps[eax + row * 24 + 8], xmm4

#define MUL_Nx4_4x6_LAST2COLUMNS_INIT                                     \
  __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1,                     \
      [esi + 10 * 4] __asm movlps xmm2, [esi + 16 * 4] __asm movlps xmm3, \
      [esi + 22 * 4] __asm shufps xmm0, xmm1,                             \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm0,                    \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm2, xmm3,                    \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm2, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_Nx4_4x6_LAST2COLUMNS_ROW2(row)                                    \
  __asm movlps xmm7, [edi + row * 32 + 0 * 4] __asm movhps xmm7,              \
      [edi + row * 32 + 4 * 4] __asm movaps xmm6, xmm7 __asm shufps xmm6,     \
      xmm6, R_SHUFFLEPS(0, 0, 3, 3) __asm mulps xmm6, xmm0 __asm shufps xmm7, \
      xmm7, R_SHUFFLEPS(1, 1, 2, 2) __asm mulps xmm7, xmm1 __asm addps xmm6,  \
      xmm7 __asm movlps xmm4, [edi + row * 32 + 2 * 4] __asm movhps xmm4,     \
      [edi + row * 32 + 6 * 4] __asm movaps xmm5, xmm4 __asm shufps xmm5,     \
      xmm5, R_SHUFFLEPS(0, 0, 3, 3) __asm mulps xmm5, xmm2 __asm addps xmm6,  \
      xmm5 __asm shufps xmm4, xmm4, R_SHUFFLEPS(1, 1, 2, 2) __asm mulps xmm4, \
      xmm3 __asm addps xmm6, xmm4 __asm movlps[eax + row * 48 + 4 * 4],       \
      xmm6 __asm movhps[eax + row * 48 + 10 * 4], xmm6

            MUL_Nx4_4x6_FIRST4COLUMNS_INIT MUL_Nx4_4x6_FIRST4COLUMNS_ROW(0)
                MUL_Nx4_4x6_FIRST4COLUMNS_ROW(1) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(
                    2) MUL_Nx4_4x6_FIRST4COLUMNS_ROW(3)
                    MUL_Nx4_4x6_LAST2COLUMNS_INIT MUL_Nx4_4x6_LAST2COLUMNS_ROW2(
                        0) MUL_Nx4_4x6_LAST2COLUMNS_ROW2(1)
      ...
      for (i = 0; i < k; i++) {
        ...
        for (j = 0; j < l; j++) {
          *dstPtr++ = m1Ptr[0] * m2Ptr[0] + m1Ptr[1] * m2Ptr[l] +
                      m1Ptr[2] * m2Ptr[2 * l] + m1Ptr[3] * m2Ptr[3 * l];
          m2Ptr++;
        }
        m1Ptr += 4;
      }
...
#define MUL_Nx5_5x6_FIRST4COLUMNS_INIT                                    \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                \
      ...
      [esi + 8 * 4] __asm movlps xmm2, [esi + 12 * 4] __asm movhps xmm2,  \
      [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, \
      [esi + 20 * 4] __asm movlps xmm4, [esi + 24 * 4] __asm movhps xmm4, \
      [esi + 26 * 4]

#define MUL_Nx5_5x6_FIRST4COLUMNS_ROW(row)                                     \
  __asm movss xmm6, [edi + row * 20 + 0 * 4] __asm shufps xmm6, xmm6,          \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,                                \
      xmm0 __asm movss xmm5, [edi + row * 20 + 1 * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm1 __asm addps xmm6,         \
      xmm5 __asm movss xmm5, [edi + row * 20 + 2 * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm6,         \
      xmm5 __asm movss xmm5, [edi + row * 20 + 3 * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm3 __asm addps xmm6,         \
      xmm5 __asm movss xmm5, [edi + row * 20 + 4 * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm addps xmm6,         \
      xmm5 __asm movlps[eax + row * 24 + 0],                                   \
      xmm6 __asm movhps[eax + row * 24 + 8], xmm6

#define MUL_Nx5_5x6_LAST2COLUMNS_INIT                                     \
  __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1,                     \
      [esi + 10 * 4] __asm movlps xmm2, [esi + 16 * 4] __asm movlps xmm3, \
      [esi + 22 * 4] __asm movlps xmm4, [esi + 28 * 4] __asm shufps xmm0, \
      xmm1, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm2,              \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm2, xmm3,                    \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm4,                    \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm4, xmm0, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_Nx5_5x6_LAST2COLUMNS_ROW2(row)                                    \
  __asm movlps xmm7, [edi + row * 40 + 0 * 4] __asm movhps xmm7,              \
      [edi + row * 40 + 6 * 4] __asm movaps xmm6, xmm7 __asm shufps xmm6,     \
      xmm6, R_SHUFFLEPS(0, 0, 2, 2) __asm mulps xmm6, xmm0 __asm movaps xmm5, \
      xmm7 __asm shufps xmm5, xmm5, R_SHUFFLEPS(1, 1, 3, 3) __asm mulps xmm5, \
      xmm1 __asm addps xmm6,                                                  \
      xmm5 __asm movlps xmm7, [edi + row * 40 + 2 * 4] __asm movhps xmm7,     \
      [edi + row * 40 + 8 * 4] __asm movaps xmm5, xmm7 __asm shufps xmm5,     \
      xmm5, R_SHUFFLEPS(0, 0, 2, 2) __asm mulps xmm5, xmm2 __asm addps xmm6,  \
      xmm5 __asm movaps xmm5, xmm7 __asm shufps xmm5, xmm5,                   \
      R_SHUFFLEPS(1, 1, 3, 3) __asm mulps xmm5, xmm3 __asm addps xmm6,        \
      xmm5 __asm movlps xmm5, [edi + row * 40 + 4 * 4] __asm shufps xmm5,     \
      xmm5, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm5, xmm4 __asm addps xmm6,  \
      xmm5 __asm movlps[eax + row * 48 + 4 * 4],                              \
      xmm6 __asm movhps[eax + row * 48 + 10 * 4], xmm6

#define MUL_Nx5_5x6_LAST2COLUMNS_ROW(row)                                    \
  __asm movlps xmm6, [edi + 20 * 4 + 0 * 4] __asm unpcklps xmm6,             \
      xmm6 __asm mulps xmm6,                                                 \
      xmm0 __asm movlps xmm5, [edi + 20 * 4 + 2 * 4] __asm unpcklps xmm5,    \
      xmm5 __asm mulps xmm5, xmm2 __asm addps xmm6,                          \
      xmm5 __asm movss xmm5, [edi + 20 * 4 + 4 * 4] __asm unpcklps xmm5,     \
      xmm5 __asm mulps xmm5, xmm4 __asm addps xmm6, xmm5 __asm movhlps xmm7, \
      xmm6 __asm addps xmm6, xmm7 __asm movlps[eax + row * 24 + 4 * 4], xmm6

            MUL_Nx5_5x6_FIRST4COLUMNS_INIT MUL_Nx5_5x6_FIRST4COLUMNS_ROW(
                0) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(1)
                MUL_Nx5_5x6_FIRST4COLUMNS_ROW(2) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(
                    3) MUL_Nx5_5x6_FIRST4COLUMNS_ROW(4)
                    MUL_Nx5_5x6_LAST2COLUMNS_INIT MUL_Nx5_5x6_LAST2COLUMNS_ROW2(
                        0) MUL_Nx5_5x6_LAST2COLUMNS_ROW2(1)
          ...
          case 6: {  // 6x5 * 5x6
            ...
            MUL_Nx5_5x6_FIRST4COLUMNS_INIT MUL_Nx5_5x6_FIRST4COLUMNS_ROW(0)
    ...
    case 6: {
      switch (k) {
        case 1: {
          if (!(l ^ 1)) {  // 1x6 * 6x1
            dstPtr[0] = m1Ptr[0] * m2Ptr[0] + m1Ptr[1] * m2Ptr[1] +
                        m1Ptr[2] * m2Ptr[2] + m1Ptr[3] * m2Ptr[3] +
                        m1Ptr[4] * m2Ptr[4] + m1Ptr[5] * m2Ptr[5];
            return;
          }
          break;
        }
...
#define MUL_Nx6_6x2_INIT                                   \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, \
      dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1,   \
      [esi + 16] __asm movaps xmm2, [esi + 32]

#define MUL_Nx6_6x2_ROW2(row)                                                  \
  __asm movaps xmm7, [edi + row * 48 + 0 * 4] __asm movaps xmm6,               \
      xmm7 __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm7,  \
      xmm0 __asm shufps xmm6, xmm6, R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm6,  \
      xmm1 __asm addps xmm7,                                                   \
      xmm6 __asm movaps xmm6, [edi + row * 48 + 4 * 4] __asm movaps xmm5,      \
      xmm6 __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6,  \
      xmm2 __asm addps xmm7, xmm6 __asm shufps xmm5, xmm5,                     \
      R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm5,                                \
      xmm0 __asm movaps xmm6, [edi + row * 48 + 24 + 2 * 4] __asm movaps xmm4, \
      xmm6 __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6,  \
      xmm1 __asm addps xmm5, xmm6 __asm shufps xmm4, xmm4,                     \
      R_SHUFFLEPS(2, 2, 3, 3) __asm mulps xmm4, xmm2 __asm addps xmm5,         \
      xmm4 __asm movaps xmm4, xmm5 __asm movhlps xmm5,                         \
      xmm7 __asm movlhps xmm7, xmm4 __asm addps xmm7,                          \
      xmm5 __asm movaps[eax + row * 16], xmm7

            MUL_Nx6_6x2_INIT MUL_Nx6_6x2_ROW2(0)
...
#define MUL_Nx6_6x3_INIT                                                 \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,               \
      dstPtr __asm movss xmm0, [esi + 0 * 4] __asm movhps xmm0,          \
      [esi + 1 * 4] __asm movss xmm1, [esi + 3 * 4] __asm movhps xmm1,   \
      [esi + 4 * 4] __asm movss xmm2, [esi + 6 * 4] __asm movhps xmm2,   \
      [esi + 7 * 4] __asm movss xmm3, [esi + 9 * 4] __asm movhps xmm3,   \
      [esi + 10 * 4] __asm movss xmm4, [esi + 12 * 4] __asm movhps xmm4, \
      [esi + 13 * 4] __asm movss xmm5, [esi + 15 * 4] __asm movhps xmm5, \
      [esi + 16 * 4]

#define MUL_Nx6_6x3_ROW(row)                                                \
  __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7,           \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,                             \
      xmm0 __asm movss xmm6, [edi + row * 24 + 4] __asm shufps xmm6, xmm6,  \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7,      \
      xmm6 __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6,  \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7,      \
      xmm6 __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7,      \
      xmm6 __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7,      \
      xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7,      \
      xmm6 __asm movss[eax + row * 12 + 0],                                 \
      xmm7 __asm movhps[eax + row * 12 + 4], xmm7

            MUL_Nx6_6x3_INIT MUL_Nx6_6x3_ROW(0) MUL_Nx6_6x3_ROW(1)
                MUL_Nx6_6x3_ROW(2)
...
#define MUL_Nx6_6x4_INIT                                          \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,        \
      dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1,          \
      [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, \
      [esi + 48] __asm movaps xmm4, [esi + 64] __asm movaps xmm5, [esi + 80]
...
#define MUL_Nx6_6x4_ROW(row)                                                \
  __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7,           \
      ...
      xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7,      \
      xmm6 __asm movaps[eax + row * 16], xmm7

            MUL_Nx6_6x4_INIT MUL_Nx6_6x4_ROW(0) MUL_Nx6_6x4_ROW(1)
                MUL_Nx6_6x4_ROW(2) MUL_Nx6_6x4_ROW(3)
...
#define MUL_Nx6_6x5_INIT                                          \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,        \
      dstPtr __asm movaps xmm0, [esi] __asm movlps xmm1,          \
      [esi + 20] __asm movhps xmm1, [esi + 28] __asm movlps xmm2, \
      [esi + 40] __asm movhps xmm2, [esi + 48] __asm movlps xmm3, \
      [esi + 60] __asm movhps xmm3, [esi + 68] __asm movaps xmm4, \
      [esi + 80] __asm movlps xmm5, [esi + 100] __asm movhps xmm5, [esi + 108]

#define MUL_Nx6_6x5_ROW(row)                                                   \
  __asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7,              \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,                                \
      xmm0 __asm fld dword ptr[edi + (row * 6 + 0) * 4] __asm fmul dword       \
          ptr[esi + (4 + 0 * 5) * 4] __asm movss xmm6,                         \
      [edi + row * 24 + 4] __asm shufps xmm6, xmm6,                            \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7,         \
      xmm6 __asm fld dword ptr[edi + (row * 6 + 1) * 4] __asm fmul dword       \
          ptr[esi + (4 + 1 * 5) * 4] __asm faddp st(1),                        \
      st __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6,       \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7,         \
      xmm6 __asm fld dword ptr[edi + (row * 6 + 2) * 4] __asm fmul dword       \
          ptr[esi + (4 + 2 * 5) * 4] __asm faddp st(1),                        \
      st __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6,      \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7,         \
      xmm6 __asm fld dword ptr[edi + (row * 6 + 3) * 4] __asm fmul dword       \
          ptr[esi + (4 + 3 * 5) * 4] __asm faddp st(1),                        \
      st __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6,      \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7,         \
      xmm6 __asm fld dword ptr[edi + (row * 6 + 4) * 4] __asm fmul dword       \
          ptr[esi + (4 + 4 * 5) * 4] __asm faddp st(1),                        \
      st __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6,      \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7,         \
      xmm6 __asm fld dword ptr[edi + (row * 6 + 5) * 4] __asm fmul dword       \
          ptr[esi + (4 + 5 * 5) * 4] __asm faddp st(1),                        \
      st __asm fstp dword ptr[eax + (row * 5 + 4) * 4] __asm movlps[eax +      \
                                                                    row * 20], \
      xmm7 __asm movhps[eax + row * 20 + 8], xmm7

            MUL_Nx6_6x5_INIT MUL_Nx6_6x5_ROW(0) MUL_Nx6_6x5_ROW(1)
                MUL_Nx6_6x5_ROW(2) MUL_Nx6_6x5_ROW(3) MUL_Nx6_6x5_ROW(4)
        ...
        case 6: {
          switch (l) {
            ...
            case 2: {  // 6x6 * 6x2
              ...
              MUL_Nx6_6x2_INIT MUL_Nx6_6x2_ROW2(0) MUL_Nx6_6x2_ROW2(1)
                  MUL_Nx6_6x2_ROW2(2)
            ...
            case 3: {  // 6x6 * 6x3
              ...
              MUL_Nx6_6x3_INIT MUL_Nx6_6x3_ROW(0) MUL_Nx6_6x3_ROW(1)
                  MUL_Nx6_6x3_ROW(2) MUL_Nx6_6x3_ROW(3) MUL_Nx6_6x3_ROW(4)
                      MUL_Nx6_6x3_ROW(5)
            ...
            case 4: {  // 6x6 * 6x4
              ...
              MUL_Nx6_6x4_INIT MUL_Nx6_6x4_ROW(0) MUL_Nx6_6x4_ROW(1)
                  MUL_Nx6_6x4_ROW(2) MUL_Nx6_6x4_ROW(3) MUL_Nx6_6x4_ROW(4)
                      MUL_Nx6_6x4_ROW(5)
            ...
            case 6: {  // 6x6 * 6x6
              __asm {
                ...
                // Calculating first 4 elements in the first row of the
                // destination matrix.
      ...
      for (i = 0; i < k; i++) {
        ...
        for (j = 0; j < l; j++) {
          *dstPtr++ = m1Ptr[0] * m2Ptr[0] + m1Ptr[1] * m2Ptr[l] +
                      m1Ptr[2] * m2Ptr[2 * l] + m1Ptr[3] * m2Ptr[3 * l] +
                      m1Ptr[4] * m2Ptr[4 * l] + m1Ptr[5] * m2Ptr[5 * l];
          m2Ptr++;
        }
        m1Ptr += 6;
      }
...
============
*/
void VPCALL idSIMD_SSE::MatX_TransposeMultiplyMatX(idMatX& dst,
                                                   const idMatX& m1,
                                                   const idMatX& m2) {
  int i, j, k, l, n;
  float* dstPtr;
...
#define MUL_2xN_2x2_INIT                                                      \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                    \
      dstPtr __asm movlps xmm0, [esi] __asm shufps xmm0, xmm0,                \
      R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm1, [esi + 8] __asm shufps xmm1, \
      xmm1, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_2xN_2x2_ROW2(N, row)                                        \
  __asm movlps xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm7,                        \
      [edi + (row + 1 * N) * 4] __asm shufps xmm7, xmm7,                \
      R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm0 __asm mulps xmm7,  \
      xmm1 __asm addps xmm6, xmm7 __asm movaps[eax + (row * 2) * 4], xmm6

        MUL_2xN_2x2_INIT MUL_2xN_2x2_ROW2(6, 0) MUL_2xN_2x2_ROW2(6, 2)
...
#define MUL_3xN_3x3_INIT                                                  \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                \
      dstPtr __asm movss xmm0, [esi + (0 * 3 + 0) * 4] __asm movhps xmm0, \
      [esi + (0 * 3 + 1) * 4] __asm movss xmm1,                           \
      [esi + (1 * 3 + 0) * 4] __asm movhps xmm1,                          \
      [esi + (1 * 3 + 1) * 4] __asm movss xmm2,                           \
      [esi + (2 * 3 + 0) * 4] __asm movhps xmm2, [esi + (2 * 3 + 1) * 4]

#define MUL_3xN_3x3_INIT_ROW4                                               \
  __asm shufps xmm0, xmm0, R_SHUFFLEPS(0, 2, 3, 0) __asm shufps xmm1, xmm1, \
      R_SHUFFLEPS(0, 2, 3, 0) __asm shufps xmm2, xmm2, R_SHUFFLEPS(0, 2, 3, 0)

#define MUL_3xN_3x3_ROW4(N, row)                                            \
  __asm movlps xmm3, [edi + (row + 0 * N + 0) * 4] __asm shufps xmm3, xmm3, \
      R_SHUFFLEPS(0, 0, 0, 1) __asm movlps xmm4,                            \
      [edi + (row + 1 * N + 0) * 4] __asm shufps xmm4, xmm4,                \
      R_SHUFFLEPS(0, 0, 0, 1) __asm movlps xmm5,                            \
      [edi + (row + 2 * N + 0) * 4] __asm shufps xmm5, xmm5,                \
      R_SHUFFLEPS(0, 0, 0, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4,      \
      xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, xmm4 __asm addps xmm3,  \
      xmm5 __asm movaps[eax + (row * 3 + 0) * 4], xmm3 __asm shufps xmm0,   \
      xmm0, R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm1, xmm1,                \
      R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm2, xmm2,                      \
      R_SHUFFLEPS(1, 2, 3, 1) __asm movlps xmm3,                            \
      [edi + (row + 0 * N + 1) * 4] __asm shufps xmm3, xmm3,                \
      R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm4,                            \
      [edi + (row + 1 * N + 1) * 4] __asm shufps xmm4, xmm4,                \
      R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm5,                            \
      [edi + (row + 2 * N + 1) * 4] __asm shufps xmm5, xmm5,                \
      R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4,      \
      xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, xmm4 __asm addps xmm3,  \
      xmm5 __asm movaps[eax + (row * 3 + 4) * 4], xmm3 __asm shufps xmm0,   \
      xmm0, R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm1, xmm1,                \
      R_SHUFFLEPS(1, 2, 3, 1) __asm shufps xmm2, xmm2,                      \
      R_SHUFFLEPS(1, 2, 3, 1) __asm movlps xmm3,                            \
      [edi + (row + 0 * N + 2) * 4] __asm shufps xmm3, xmm3,                \
      R_SHUFFLEPS(0, 1, 1, 1) __asm movlps xmm4,                            \
      [edi + (row + 1 * N + 2) * 4] __asm shufps xmm4, xmm4,                \
      R_SHUFFLEPS(0, 1, 1, 1) __asm movlps xmm5,                            \
      [edi + (row + 2 * N + 2) * 4] __asm shufps xmm5, xmm5,                \
      R_SHUFFLEPS(0, 1, 1, 1) __asm mulps xmm3, xmm0 __asm mulps xmm4,      \
      xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, xmm4 __asm addps xmm3,  \
      xmm5 __asm movaps[eax + (row * 3 + 8) * 4], xmm3

#define MUL_3xN_3x3_INIT_ROW4_ROW4                                          \
  __asm shufps xmm0, xmm0, R_SHUFFLEPS(1, 2, 3, 0) __asm shufps xmm1, xmm1, \
      R_SHUFFLEPS(1, 2, 3, 0) __asm shufps xmm2, xmm2, R_SHUFFLEPS(1, 2, 3, 0)

#define MUL_3xN_3x3_INIT_ROW4_ROW                                           \
  __asm shufps xmm0, xmm0, R_SHUFFLEPS(1, 1, 2, 3) __asm shufps xmm1, xmm1, \
      R_SHUFFLEPS(1, 1, 2, 3) __asm shufps xmm2, xmm2, R_SHUFFLEPS(1, 1, 2, 3)

#define MUL_3xN_3x3_ROW(N, row)                                            \
  __asm movss xmm3, [edi + (row + 0 * N) * 4] __asm shufps xmm3, xmm3,     \
      R_SHUFFLEPS(0, 0, 0, 0) __asm movss xmm4,                            \
      [edi + (row + 1 * N) * 4] __asm shufps xmm4, xmm4,                   \
      R_SHUFFLEPS(0, 0, 0, 0) __asm movss xmm5,                            \
      [edi + (row + 2 * N) * 4] __asm shufps xmm5, xmm5,                   \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm3, xmm0 __asm mulps xmm4,     \
      xmm1 __asm mulps xmm5, xmm2 __asm addps xmm3, xmm4 __asm addps xmm3, \
      xmm5 __asm movss[eax + (row * 3 + 0) * 4],                           \
      xmm3 __asm movhps[eax + (row * 3 + 1) * 4], xmm3

        MUL_3xN_3x3_INIT MUL_3xN_3x3_INIT_ROW4 MUL_3xN_3x3_ROW4(6, 0)
            MUL_3xN_3x3_INIT_ROW4_ROW MUL_3xN_3x3_ROW(6, 4)
                MUL_3xN_3x3_ROW(6, 5)
...
#define MUL_4xN_4x4_INIT                                   \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, \
      dstPtr __asm movaps xmm0, [esi] __asm movaps xmm1,   \
      [esi + 16] __asm movaps xmm2, [esi + 32] __asm movaps xmm3, [esi + 48]

#define MUL_4xN_4x4_ROW(N, row)                                              \
  __asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7,       \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,                              \
      xmm0 __asm movss xmm6, [edi + (row + 1 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, \
      xmm6 __asm movss xmm6, [edi + (row + 2 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, \
      xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, \
      xmm6 __asm movaps[eax + row * 16], xmm7

        MUL_4xN_4x4_INIT MUL_4xN_4x4_ROW(6, 0) MUL_4xN_4x4_ROW(6, 1)
            MUL_4xN_4x4_ROW(6, 2) MUL_4xN_4x4_ROW(6, 3) MUL_4xN_4x4_ROW(6, 4)
                MUL_4xN_4x4_ROW(6, 5)
      ...
      for (i = 0; i < k; i++) {
        ...
        for (j = 0; j < l; j++) {
          *dstPtr++ = m1Ptr[0] * m2Ptr[0] + m1Ptr[k] * m2Ptr[l] +
                      m1Ptr[2 * k] * m2Ptr[2 * l] + m1Ptr[3 * k] * m2Ptr[3 * l];
          m2Ptr++;
        }
        m1Ptr++;
      }
...
#define MUL_5xN_5x5_INIT                                                  \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                \
      dstPtr __asm movlps xmm0, [esi + 0 * 4] __asm movhps xmm0,          \
      [esi + 2 * 4] __asm movlps xmm1, [esi + 5 * 4] __asm movhps xmm1,   \
      [esi + 7 * 4] __asm movlps xmm2, [esi + 10 * 4] __asm movhps xmm2,  \
      [esi + 12 * 4] __asm movlps xmm3, [esi + 15 * 4] __asm movhps xmm3, \
      [esi + 17 * 4] __asm movlps xmm4, [esi + 20 * 4] __asm movhps xmm4, \
      [esi + 22 * 4]

#define MUL_5xN_5x5_ROW(N, row)                                               \
  __asm movss xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6,        \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6,                               \
      xmm0 __asm fld dword ptr[edi + (row + 0 * N) * 4] __asm fmul dword      \
          ptr[esi + 4 * 4] __asm movss xmm5,                                  \
      [edi + (row + 1 * N) * 4] __asm shufps xmm5, xmm5,                      \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm1 __asm addps xmm6,        \
      xmm5 __asm fld dword ptr[edi + (row + 1 * N) * 4] __asm fmul dword      \
          ptr[esi + 9 * 4] __asm faddp st(1),                                 \
      st __asm movss xmm5, [edi + (row + 2 * N) * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm6,        \
      xmm5 __asm fld dword ptr[edi + (row + 2 * N) * 4] __asm fmul dword      \
          ptr[esi + 14 * 4] __asm faddp st(1),                                \
      st __asm movss xmm5, [edi + (row + 3 * N) * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm3 __asm addps xmm6,        \
      xmm5 __asm fld dword ptr[edi + (row + 3 * N) * 4] __asm fmul dword      \
          ptr[esi + 19 * 4] __asm faddp st(1),                                \
      st __asm movss xmm5, [edi + (row + 4 * N) * 4] __asm shufps xmm5, xmm5, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm4 __asm addps xmm6,        \
      xmm5 __asm fld dword ptr[edi + (row + 4 * N) * 4] __asm fmul dword      \
          ptr[esi + 24 * 4] __asm faddp st(1),                                \
      st __asm fstp dword                                                     \
          ptr[eax + (row * 5 + 4) * 4] __asm movlps[eax + (row * 5 + 0) * 4], \
      xmm6 __asm movhps[eax + (row * 5 + 2) * 4], xmm6

        MUL_5xN_5x5_INIT MUL_5xN_5x5_ROW(6, 0) MUL_5xN_5x5_ROW(6, 1)
            MUL_5xN_5x5_ROW(6, 2) MUL_5xN_5x5_ROW(6, 3) MUL_5xN_5x5_ROW(6, 4)
                MUL_5xN_5x5_ROW(6, 5)
...
#define MUL_6xN_6x6_FIRST4COLUMNS_INIT                                    \
  __asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax,                \
      ...
      [esi + 14 * 4] __asm movlps xmm3, [esi + 18 * 4] __asm movhps xmm3, \
      [esi + 20 * 4] __asm movlps xmm4, [esi + 24 * 4] __asm movhps xmm4, \
      [esi + 26 * 4] __asm movlps xmm5, [esi + 30 * 4] __asm movhps xmm5, \
      [esi + 32 * 4]
...
#define MUL_6xN_6x6_FIRST4COLUMNS_ROW(N, row)                                \
  __asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7,       \
      ...
      xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, \
      xmm6 __asm movss xmm6, [edi + (row + 4 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7, \
      xmm6 __asm movss xmm6, [edi + (row + 5 * N) * 4] __asm shufps xmm6,    \
      xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, \
      xmm6 __asm movlps[eax + (row * 6 + 0) * 4],                            \
      xmm7 __asm movhps[eax + (row * 6 + 2) * 4], xmm7

#define MUL_6xN_6x6_LAST2COLUMNS_INIT                                     \
  __asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1,                     \
      [esi + 10 * 4] __asm shufps xmm0, xmm0,                             \
      R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm1,                    \
      R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm2,                          \
      [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm shufps xmm2, \
      xmm2, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm3,              \
      R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm4,                          \
      [esi + 28 * 4] __asm movlps xmm5, [esi + 34 * 4] __asm shufps xmm4, \
      xmm4, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm5, xmm5,              \
      R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_6xN_6x6_LAST2COLUMNS_ROW2(N, row)                                  \
  __asm movlps xmm7, [edi + (row * 2 + 0 * N) * 4] __asm shufps xmm7, xmm7,    \
      R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm7,                                \
      xmm0 __asm movlps xmm6, [edi + (row * 2 + 1 * N) * 4] __asm shufps xmm6, \
      xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm1 __asm addps xmm7,   \
      xmm6 __asm movlps xmm6, [edi + (row * 2 + 2 * N) * 4] __asm shufps xmm6, \
      xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm2 __asm addps xmm7,   \
      xmm6 __asm movlps xmm6, [edi + (row * 2 + 3 * N) * 4] __asm shufps xmm6, \
      xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm3 __asm addps xmm7,   \
      xmm6 __asm movlps xmm6, [edi + (row * 2 + 4 * N) * 4] __asm shufps xmm6, \
      xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm4 __asm addps xmm7,   \
      xmm6 __asm movlps xmm6, [edi + (row * 2 + 5 * N) * 4] __asm shufps xmm6, \
      xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm5 __asm addps xmm7,   \
      xmm6 __asm movlps[eax + (row * 12 + 4) * 4],                             \
      xmm7 __asm movhps[eax + (row * 12 + 10) * 4], xmm7

#define MUL_6xN_6x6_LAST2COLUMNS_ROW(N, row)                                  \
  __asm movss xmm7, [edi + (1 * N - 1) * 4] __asm shufps xmm7, xmm7,          \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7,                               \
      xmm0 __asm movss xmm6, [edi + (2 * N - 1) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7,        \
      xmm6 __asm movss xmm6, [edi + (3 * N - 1) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7,        \
      xmm6 __asm movss xmm6, [edi + (4 * N - 1) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7,        \
      xmm6 __asm movss xmm6, [edi + (5 * N - 1) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7,        \
      xmm6 __asm movss xmm6, [edi + (6 * N - 1) * 4] __asm shufps xmm6, xmm6, \
      R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7,        \
      xmm6 __asm movlps[eax + (row * 6 + 4) * 4], xmm7

            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(1, 0)
                MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW(1, 0)

                    return;
          }
          case 2: {  // 6x2 * 6x6

            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(2, 0)
                MUL_6xN_6x6_FIRST4COLUMNS_ROW(2, 1)
                    MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(
                        2, 0)
          ...
          case 3: {  // 6x3 * 6x6
            ...
            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(
                3, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(3, 1)
                MUL_6xN_6x6_FIRST4COLUMNS_ROW(3, 2)
                    MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(
                        3, 0) MUL_6xN_6x6_LAST2COLUMNS_ROW(3, 2)
          ...
          case 4: {  // 6x4 * 6x6
            ...
            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(
                4, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 1)
                MUL_6xN_6x6_FIRST4COLUMNS_ROW(
                    4, 2) MUL_6xN_6x6_FIRST4COLUMNS_ROW(4, 3)
                    MUL_6xN_6x6_LAST2COLUMNS_INIT MUL_6xN_6x6_LAST2COLUMNS_ROW2(
                        4, 0) MUL_6xN_6x6_LAST2COLUMNS_ROW2(4, 1)

                        return;
          }
          case 5: {  // 6x5 * 6x6

            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(5, 0)
          ...
          case 6: {  // 6x6 * 6x6
            ...
            MUL_6xN_6x6_FIRST4COLUMNS_INIT MUL_6xN_6x6_FIRST4COLUMNS_ROW(
                6, 0) MUL_6xN_6x6_FIRST4COLUMNS_ROW(6, 1)
      ...
      for (i = 0; i < k; i++) {
        ...
        for (j = 0; j < l; j++) {
          *dstPtr++ = m1Ptr[0] * m2Ptr[0] + m1Ptr[k] * m2Ptr[l] +
                      m1Ptr[2 * k] * m2Ptr[2 * l] +
                      m1Ptr[3 * k] * m2Ptr[3 * l] +
                      m1Ptr[4 * k] * m2Ptr[4 * l] + m1Ptr[5 * k] * m2Ptr[5 * l];
          m2Ptr++;
        }
        m1Ptr++;
      }
...
============
*/
void VPCALL idSIMD_SSE::MatX_LowerTriangularSolve(const idMatX& L,
                                                  float* x,
                                                  const float* b,
                                                  const int n,
                                                  int skip) {
...
#define NSKIP(n, s) ((n << 3) | (s & 7))
    switch (NSKIP(n, skip)) {
      ...
      case NSKIP(4, 2):
        x[2] = b[2] - lptr[2 * nc + 0] * x[0] - lptr[2 * nc + 1] * x[1];
      case NSKIP(4, 3):
        x[3] = b[3] - lptr[3 * nc + 0] * x[0] - lptr[3 * nc + 1] * x[1] -
               lptr[3 * nc + 2] * x[2];
        return;
      case NSKIP(5, 0):
        x[0] = b[0];
      ...
      case NSKIP(5, 3):
        x[3] = b[3] - lptr[3 * nc + 0] * x[0] - lptr[3 * nc + 1] * x[1] -
               lptr[3 * nc + 2] * x[2];
      case NSKIP(5, 4):
        x[4] = b[4] - lptr[4 * nc + 0] * x[0] - lptr[4 * nc + 1] * x[1] -
               lptr[4 * nc + 2] * x[2] - lptr[4 * nc + 3] * x[3];
        return;
      case NSKIP(6, 0):
        x[0] = b[0];
      case NSKIP(6, 1):
      ...
      case NSKIP(6, 4):
        x[4] = b[4] - lptr[4 * nc + 0] * x[0] - lptr[4 * nc + 1] * x[1] -
               lptr[4 * nc + 2] * x[2] - lptr[4 * nc + 3] * x[3];
      case NSKIP(6, 5):
        x[5] = b[5] - lptr[5 * nc + 0] * x[0] - lptr[5 * nc + 1] * x[1] -
               lptr[5 * nc + 2] * x[2] - lptr[5 * nc + 3] * x[3] -
               lptr[5 * nc + 4] * x[4];
        return;
      case NSKIP(7, 0):
        x[0] = b[0];
      ...
      case NSKIP(7, 5):
        x[5] = b[5] - lptr[5 * nc + 0] * x[0] - lptr[5 * nc + 1] * x[1] -
               ...
               lptr[5 * nc + 4] * x[4];
      case NSKIP(7, 6):
        x[6] = b[6] - lptr[6 * nc + 0] * x[0] - lptr[6 * nc + 1] * x[1] -
               lptr[6 * nc + 2] * x[2] - lptr[6 * nc + 3] * x[3] -
               lptr[6 * nc + 4] * x[4] - lptr[6 * nc + 5] * x[5];
        return;
    }
    return;
  }
...
============
*/
void VPCALL idSIMD_SSE::MatX_LowerTriangularSolveTranspose(const idMatX& L,
                                                           float* x,
                                                           const float* b,
                                                           const int n) {
  int nc;
  ...
  if (n < 8) {
    switch (n) {
      ...
      case 4:
        ...
        x[0] = b[0] - lptr[3 * nc + 0] * x[3] - lptr[2 * nc + 0] * x[2] -
               lptr[1 * nc + 0] * x[1];
        return;
      case 5:
        x[4] = b[4];
        ...
        x[1] = b[1] - lptr[4 * nc + 1] * x[4] - lptr[3 * nc + 1] * x[3] -
               lptr[2 * nc + 1] * x[2];
        x[0] = b[0] - lptr[4 * nc + 0] * x[4] - lptr[3 * nc + 0] * x[3] -
               lptr[2 * nc + 0] * x[2] - lptr[1 * nc + 0] * x[1];
        return;
      case 6:
        x[5] = b[5];
        x[4] = b[4] - lptr[5 * nc + 4] * x[5];
        x[3] = b[3] - lptr[5 * nc + 3] * x[5] - lptr[4 * nc + 3] * x[4];
        x[2] = b[2] - lptr[5 * nc + 2] * x[5] - lptr[4 * nc + 2] * x[4] -
               lptr[3 * nc + 2] * x[3];
        x[1] = b[1] - lptr[5 * nc + 1] * x[5] - lptr[4 * nc + 1] * x[4] -
               lptr[3 * nc + 1] * x[3] - lptr[2 * nc + 1] * x[2];
        x[0] = b[0] - lptr[5 * nc + 0] * x[5] - lptr[4 * nc + 0] * x[4] -
               lptr[3 * nc + 0] * x[3] - lptr[2 * nc + 0] * x[2] -
               lptr[1 * nc + 0] * x[1];
        return;
      case 7:
        x[6] = b[6];
        ...
        x[3] = b[3] - lptr[6 * nc + 3] * x[6] - lptr[5 * nc + 3] * x[5] -
               lptr[4 * nc + 3] * x[4];
        x[2] = b[2] - lptr[6 * nc + 2] * x[6] - lptr[5 * nc + 2] * x[5] -
               lptr[4 * nc + 2] * x[4] - lptr[3 * nc + 2] * x[3];
        x[1] = b[1] - lptr[6 * nc + 1] * x[6] - lptr[5 * nc + 1] * x[5] -
               lptr[4 * nc + 1] * x[4] - lptr[3 * nc + 1] * x[3] -
               lptr[2 * nc + 1] * x[2];
        x[0] = b[0] - lptr[6 * nc + 0] * x[6] - lptr[5 * nc + 0] * x[5] -
               lptr[4 * nc + 0] * x[4] - lptr[3 * nc + 0] * x[3] -
               lptr[2 * nc + 0] * x[2] - lptr[1 * nc + 0] * x[1];
        return;
    }
    return;
...
============
*/
bool VPCALL idSIMD_SSE::MatX_LDLTFactor(idMatX& mat,
                                        idVecX& invDiag,
                                        const int n) {
#if 1
  ...
  for (j = 3; j < n; j++) {
    mptr[j * nc + 2] =
        (mptr[j * nc + 2] - v[0] * mptr[j * nc + 0] - v[1] * mptr[j * nc + 1]) *
        d;
  }
  ...
  mptr = mat[0];
  for (j = 4; j < n; j++) {
    mptr[j * nc + 3] = (mptr[j * nc + 3] - v[0] * mptr[j * nc + 0] -
                        v[1] * mptr[j * nc + 1] - v[2] * mptr[j * nc + 2]) *
                       d;
  }
...
void VPCALL idSIMD_SSE::BlendJoints(idJointQuat* joints,
  ...
  for (; i < numJoints; i++) {
    ...
    cosom = jointQuat.x * blendQuat.x + jointQuat.y * blendQuat.y +
            jointQuat.z * blendQuat.z + jointQuat.w * blendQuat.w;
...
*/
void VPCALL
idSIMD_SSE::ConvertJointQuatsToJointMats(idJointMat* jointMats,
                                         const idJointQuat* jointQuats,
                                         const int numJoints) {
  assert(sizeof(idJointQuat) == JOINTQUAT_SIZE);
  assert(sizeof(idJointMat) == JOINTMAT_SIZE);
  assert((int)(&((idJointQuat*)0)->t) ==
         (int)(&((idJointQuat*)0)->q) + (int)sizeof(((idJointQuat*)0)->q));
...
*/
void VPCALL
idSIMD_SSE::ConvertJointMatsToJointQuats(idJointQuat* jointQuats,
...
============
*/
void VPCALL idSIMD_SSE::UntransformJoints(idJointMat* jointMats,
                                          const int* parents,
                                          const int firstJoint,
                                          const int lastJoint) {
#if 1
...
============
*/
void VPCALL idSIMD_SSE::TransformVerts(idDrawVert* verts,
                                       const int numVerts,
...
============
*/
void VPCALL idSIMD_SSE::TracePointCull(byte* cullBits,
                                       byte& totalOr,
                                       const float radius,
  ...
  for (i = 0; i < numVerts; i++) {
    ...
    d0 = planes[0][0] * v[0] + planes[0][1] * v[1] + planes[0][2] * v[2] +
         planes[0][3];
    d1 = planes[1][0] * v[0] + planes[1][1] * v[1] + planes[1][2] * v[2] +
         planes[1][3];
    d2 = planes[2][0] * v[0] + planes[2][1] * v[1] + planes[2][2] * v[2] +
         planes[2][3];
    d3 = planes[3][0] * v[0] + planes[3][1] * v[1] + planes[3][2] * v[2] +
         planes[3][3];
...
============
*/
void VPCALL idSIMD_SSE::DecalPointCull(byte* cullBits,
                                       const idPlane* planes,
                                       const idDrawVert* verts,
                                       const int numVerts) {
#if 1
  ...
  for (i = 0; i < numVerts; i += 2) {
    ...
    d0 = planes[0][0] * v0[0] + planes[0][1] * v0[1] + planes[0][2] * v0[2] +
         planes[0][3];
    d1 = planes[1][0] * v0[0] + planes[1][1] * v0[1] + planes[1][2] * v0[2] +
         planes[1][3];
    d2 = planes[2][0] * v0[0] + planes[2][1] * v0[1] + planes[2][2] * v0[2] +
         planes[2][3];
    d3 = planes[3][0] * v0[0] + planes[3][1] * v0[1] + planes[3][2] * v0[2] +
         planes[3][3];

    d4 = planes[4][0] * v0[0] + planes[4][1] * v0[1] + planes[4][2] * v0[2] +
         planes[4][3];
    d5 = planes[5][0] * v0[0] + planes[5][1] * v0[1] + planes[5][2] * v0[2] +
         planes[5][3];
    d10 = planes[4][0] * v1[0] + planes[4][1] * v1[1] + planes[4][2] * v1[2] +
          planes[4][3];
    d11 = planes[5][0] * v1[0] + planes[5][1] * v1[1] + planes[5][2] * v1[2] +
          planes[5][3];

    d6 = planes[0][0] * v1[0] + planes[0][1] * v1[1] + planes[0][2] * v1[2] +
         planes[0][3];
    d7 = planes[1][0] * v1[0] + planes[1][1] * v1[1] + planes[1][2] * v1[2] +
         planes[1][3];
    d8 = planes[2][0] * v1[0] + planes[2][1] * v1[1] + planes[2][2] * v1[2] +
         planes[2][3];
    d9 = planes[3][0] * v1[0] + planes[3][1] * v1[1] + planes[3][2] * v1[2] +
         planes[3][3];
  ...
  if (numVerts & 1) {
    ...
    d4 = planes[4][0] * v[0] + planes[4][1] * v[1] + planes[4][2] * v[2] +
         planes[4][3];
    d5 = planes[5][0] * v[0] + planes[5][1] * v[1] + planes[5][2] * v[2] +
         planes[5][3];
...
============
*/
void VPCALL idSIMD_SSE::OverlayPointCull(byte* cullBits,
                                         idVec2* texCoords,
                                         const idPlane* planes,
                                         const idDrawVert* verts,
                                         const int numVerts) {
...
============
*/
void VPCALL idSIMD_SSE::DeriveTriPlanes(idPlane* planes,
                                        const idDrawVert* verts,
                                        const int numVerts,
                                        const int* indexes,
...
void VPCALL idSIMD_SSE::DeriveTangents(idPlane* planes,
                                       idDrawVert* verts,
                                       const int numVerts,
                                       const int* indexes,
                                       const int numIndexes) {
...
void VPCALL
idSIMD_SSE::DeriveUnsmoothedTangents(idDrawVert* verts,
...
============
*/
void VPCALL idSIMD_SSE::NormalizeTangents(idDrawVert* verts,
                                          const int numVerts) {
...
*/
void VPCALL
idSIMD_SSE::CreateTextureSpaceLightVectors(idVec3* lightVectors,
  ...
  for (int i = 0; i < numVerts; i++) {
    ...
    lightVectors[i][0] = lightDir[0] * v->tangents[0][0] +
                         lightDir[1] * v->tangents[0][1] +
                         lightDir[2] * v->tangents[0][2];
    lightVectors[i][1] = lightDir[0] * v->tangents[1][0] +
                         lightDir[1] * v->tangents[1][1] +
                         lightDir[2] * v->tangents[1][2];
    lightVectors[i][2] = lightDir[0] * v->normal[0] +
                         lightDir[1] * v->normal[1] +
                         lightDir[2] * v->normal[2];
  }
  ...
  for (int i = 0; i < numUsedVerts; i++) {
    lightVectors0[i] = lightDir0[i] * tangent0[i] + lightDir1[i] * tangent1[i] +
                       lightDir2[i] * tangent2[i];
    lightVectors1[i] = lightDir0[i] * tangent3[i] + lightDir1[i] * tangent4[i] +
                       lightDir2[i] * tangent5[i];
    lightVectors2[i] = lightDir0[i] * normal0[i] + lightDir1[i] * normal1[i] +
                       lightDir2[i] * normal2[i];
...
============
*/
void VPCALL idSIMD_SSE::CreateSpecularTextureCoords(idVec4* texCoords,
                                                    const idVec3& lightOrigin,
  ...
  for (int i = 0; i < numVerts; i++) {
    ...
    ilength =
        idMath::RSqrt(lightDir[0] * lightDir[0] + lightDir[1] * lightDir[1] +
                      lightDir[2] * lightDir[2]);
    lightDir[0] *= ilength;
    lightDir[1] *= ilength;
    lightDir[2] *= ilength;

    ilength = idMath::RSqrt(viewDir[0] * viewDir[0] + viewDir[1] * viewDir[1] +
                            viewDir[2] * viewDir[2]);
    viewDir[0] *= ilength;
    viewDir[1] *= ilength;
    viewDir[2] *= ilength;
    ...
    texCoords[i][0] = lightDir[0] * v->tangents[0][0] +
                      lightDir[1] * v->tangents[0][1] +
                      lightDir[2] * v->tangents[0][2];
    texCoords[i][1] = lightDir[0] * v->tangents[1][0] +
                      lightDir[1] * v->tangents[1][1] +
                      lightDir[2] * v->tangents[1][2];
    texCoords[i][2] = lightDir[0] * v->normal[0] + lightDir[1] * v->normal[1] +
                      lightDir[2] * v->normal[2];
    texCoords[i][3] = 1.0f;
  }
  ...
  for (int i = 0; i < numUsedVerts; i++) {
    ...
    temp = lightDir0[i] * lightDir0[i] + lightDir1[i] * lightDir1[i] +
           lightDir2[i] * lightDir2[i];
    ...
    temp = viewDir0[i] * viewDir0[i] + viewDir1[i] * viewDir1[i] +
           viewDir2[i] * viewDir2[i];
    temp = idMath::RSqrt(temp);
    ...
    texCoords0[i] = lightDir0[i] * tangent0[i] + lightDir1[i] * tangent1[i] +
                    lightDir2[i] * tangent2[i];
    texCoords1[i] = lightDir0[i] * tangent3[i] + lightDir1[i] * tangent4[i] +
                    lightDir2[i] * tangent5[i];
    texCoords2[i] = lightDir0[i] * normal0[i] + lightDir1[i] * normal1[i] +
                    lightDir2[i] * normal2[i];
...
============
*/
int VPCALL idSIMD_SSE::CreateShadowCache(idVec4* vertexCache,
                                         int* vertRemap,
                                         const idVec3& lightOrigin,
                                         const idDrawVert* verts,
                                         const int numVerts) {
...
============
*/
int VPCALL idSIMD_SSE::CreateVertexProgramShadowCache(idVec4* vertexCache,
                                                      const idDrawVert* verts,
                                                      const int numVerts) {
#if 1
...
============
*/
static void SSE_UpSample11kHzMonoPCMTo44kHz(float* dest,
                                            const short* src,
...
============
*/
static void SSE_UpSample11kHzStereoPCMTo44kHz(float* dest,
                                              const short* src,
                                              const int numSamples) {
  __asm {
		mov			esi, src
...
============
*/
static void SSE_UpSample22kHzMonoPCMTo44kHz(float* dest,
                                            const short* src,
                                            const int numSamples) {
  __asm {
		mov			esi, src
...
============
*/
static void SSE_UpSample22kHzStereoPCMTo44kHz(float* dest,
                                              const short* src,
                                              const int numSamples) {
  __asm {
		mov			esi, src
...
============
*/
static void SSE_UpSample44kHzMonoPCMTo44kHz(float* dest,
                                            const short* src,
                                            const int numSamples) {
  __asm {
		mov			esi, src
...
============
*/
void idSIMD_SSE::UpSamplePCMTo44kHz(float* dest,
                                    const short* src,
                                    const int numSamples,
                                    const int kHz,
...
============
*/
static void SSE_UpSample11kHzMonoOGGTo44kHz(float* dest,
                                            const float* src,
                                            const int numSamples) {
...
============
*/
static void SSE_UpSample11kHzStereoOGGTo44kHz(float* dest,
...
============
*/
static void SSE_UpSample22kHzMonoOGGTo44kHz(float* dest,
                                            const float* src,
                                            const int numSamples) {
  float constant = 32768.0f;
  __asm {
...
============
*/
static void SSE_UpSample22kHzStereoOGGTo44kHz(float* dest,
                                              const float* const* src,
                                              const int numSamples) {
  float constant = 32768.0f;
  __asm {
...
============
*/
static void SSE_UpSample44kHzMonoOGGTo44kHz(float* dest,
                                            const float* src,
                                            const int numSamples) {
  float constant = 32768.0f;
...
============
*/
static void SSE_UpSample44kHzStereoOGGTo44kHz(float* dest,
                                              const float* const* src,
                                              const int numSamples) {
  float constant = 32768.0f;
  __asm {
...
============
*/
void idSIMD_SSE::UpSampleOGGTo44kHz(float* dest,
...
============
*/
void VPCALL idSIMD_SSE::MixSoundTwoSpeakerMono(float* mixBuffer,
                                               const float* samples,
                                               const int numSamples,
                                               const float lastV[2],
...
============
*/
void VPCALL idSIMD_SSE::MixSoundTwoSpeakerStereo(float* mixBuffer,
                                                 const float* samples,
                                                 const int numSamples,
                                                 const float lastV[2],
                                                 const float currentV[2]) {
...
============
*/
void VPCALL idSIMD_SSE::MixSoundSixSpeakerMono(float* mixBuffer,
                                               const float* samples,
                                               const int numSamples,
                                               const float lastV[6],
...
============
*/
void VPCALL idSIMD_SSE::MixSoundSixSpeakerStereo(float* mixBuffer,
                                                 const float* samples,
                                                 const int numSamples,
                                                 const float lastV[6],
                                                 const float currentV[6]) {
...
============
*/
void VPCALL idSIMD_SSE::MixedSoundToSamples(short* samples,
