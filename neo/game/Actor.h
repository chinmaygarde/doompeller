...
class idActor : public idAFEntity_Gibbable {
 ...
 protected:
  ...
  int pain_threshold;      // how much damage monster can take at any one time
                           // before playing pain animation
  ...
  idList<copyJoints_t>
      copyJoints;  // copied from the body animation to the head model
