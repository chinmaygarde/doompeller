...
===============================================================================
        ...
        is a performance cost with using them for continuous effects. The
general particle systems are completely parametric, and have no performance
...
class idSmokeParticles {
 public:
  ...
  // creats an entity covering the entire world that will call back each
  // rendering
  void Init(void);
  void Shutdown(void);

  // spits out a particle, returning false if the system will not emit any more
  // particles in the future
  bool EmitSmoke(const idDeclParticle* smoke,
                 const int startTime,
